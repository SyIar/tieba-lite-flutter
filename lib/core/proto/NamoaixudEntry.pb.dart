...
class NamoaixudEntry extends $pb.GeneratedMessage {
  ...
  factory NamoaixudEntry.fromBuffer($core.List<$core.int> data,
      ...
      NamoaixudEntry()..mergeFromBuffer(data, registry);
  factory NamoaixudEntry.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      NamoaixudEntry()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'NamoaixudEntry',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: NamoaixudEntry.$_createMessage)
  ...
  @$core.Deprecated('Use NamoaixudEntry() / NamoaixudEntry.new instead')
  static NamoaixudEntry create() => NamoaixudEntry._();
  static $pb.GeneratedMessage $_createMessage() => NamoaixudEntry._();
  @$core.override
  NamoaixudEntry createEmptyInstance() => NamoaixudEntry._();
  @$core.pragma('dart2js:noInline')
  static NamoaixudEntry getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NamoaixudEntry>(
          NamoaixudEntry.$_createMessage);

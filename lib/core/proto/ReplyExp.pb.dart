...
class ReplyExp extends $pb.GeneratedMessage {
  ...
  factory ReplyExp.fromBuffer($core.List<$core.int> data,
      ...
      ReplyExp()..mergeFromBuffer(data, registry);
  factory ReplyExp.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ReplyExp()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ReplyExp',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ReplyExp.$_createMessage)
  ...
  @$core.Deprecated('Use ReplyExp() / ReplyExp.new instead')
  static ReplyExp create() => ReplyExp._();
  static $pb.GeneratedMessage $_createMessage() => ReplyExp._();
  @$core.override
  ReplyExp createEmptyInstance() => ReplyExp._();
  @$core.pragma('dart2js:noInline')
  static ReplyExp getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ReplyExp>(ReplyExp.$_createMessage);

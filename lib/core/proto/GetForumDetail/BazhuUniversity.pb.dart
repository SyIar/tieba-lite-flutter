...
class BazhuUniversity extends $pb.GeneratedMessage {
  factory BazhuUniversity({
    ...
    final result = BazhuUniversity._();
  ...
  @$core.Deprecated('Use BazhuUniversity() / BazhuUniversity.new instead')
  static BazhuUniversity create() => BazhuUniversity._();
  static $pb.GeneratedMessage $_createMessage() => BazhuUniversity._();
  @$core.override
  BazhuUniversity createEmptyInstance() => BazhuUniversity._();
  @$core.pragma('dart2js:noInline')
  static BazhuUniversity getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BazhuUniversity>(
          BazhuUniversity.$_createMessage);

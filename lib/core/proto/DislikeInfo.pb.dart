...
class DislikeInfo extends $pb.GeneratedMessage {
  ...
  factory DislikeInfo.fromBuffer($core.List<$core.int> data,
      ...
      DislikeInfo()..mergeFromBuffer(data, registry);
  factory DislikeInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      DislikeInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DislikeInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: DislikeInfo.$_createMessage)
  ...
  @$core.Deprecated('Use DislikeInfo() / DislikeInfo.new instead')
  static DislikeInfo create() => DislikeInfo._();
  static $pb.GeneratedMessage $_createMessage() => DislikeInfo._();
  @$core.override
  DislikeInfo createEmptyInstance() => DislikeInfo._();
  @$core.pragma('dart2js:noInline')
  static DislikeInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DislikeInfo>(
          DislikeInfo.$_createMessage);

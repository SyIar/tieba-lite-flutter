...
class Lbs extends $pb.GeneratedMessage {
  ...
  factory Lbs.fromBuffer($core.List<$core.int> data,
      ...
      Lbs()..mergeFromBuffer(data, registry);
  factory Lbs.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Lbs()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Lbs',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Lbs.$_createMessage)
  ...
  @$core.Deprecated('Use Lbs() / Lbs.new instead')
  static Lbs create() => Lbs._();
  static $pb.GeneratedMessage $_createMessage() => Lbs._();
  @$core.override
  Lbs createEmptyInstance() => Lbs._();
  @$core.pragma('dart2js:noInline')
  static Lbs getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Lbs>(Lbs.$_createMessage);

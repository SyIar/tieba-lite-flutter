...
class IconStampInfo extends $pb.GeneratedMessage {
  ...
  factory IconStampInfo.fromBuffer($core.List<$core.int> data,
      ...
      IconStampInfo()..mergeFromBuffer(data, registry);
  factory IconStampInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      IconStampInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'IconStampInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: IconStampInfo.$_createMessage)
  ...
  @$core.Deprecated('Use IconStampInfo() / IconStampInfo.new instead')
  static IconStampInfo create() => IconStampInfo._();
  static $pb.GeneratedMessage $_createMessage() => IconStampInfo._();
  @$core.override
  IconStampInfo createEmptyInstance() => IconStampInfo._();
  @$core.pragma('dart2js:noInline')
  static IconStampInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IconStampInfo>(
          IconStampInfo.$_createMessage);

...
class ApkDetail extends $pb.GeneratedMessage {
  ...
  factory ApkDetail.fromBuffer($core.List<$core.int> data,
      ...
      ApkDetail()..mergeFromBuffer(data, registry);
  factory ApkDetail.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ApkDetail()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ApkDetail',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ApkDetail.$_createMessage)
  ...
  @$core.Deprecated('Use ApkDetail() / ApkDetail.new instead')
  static ApkDetail create() => ApkDetail._();
  static $pb.GeneratedMessage $_createMessage() => ApkDetail._();
  @$core.override
  ApkDetail createEmptyInstance() => ApkDetail._();
  @$core.pragma('dart2js:noInline')
  static ApkDetail getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ApkDetail>(ApkDetail.$_createMessage);

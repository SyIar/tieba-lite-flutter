...
class FeedExtInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use FeedExtInfo() / FeedExtInfo.new instead')
  static FeedExtInfo create() => FeedExtInfo._();
  static $pb.GeneratedMessage $_createMessage() => FeedExtInfo._();
  @$core.override
  FeedExtInfo createEmptyInstance() => FeedExtInfo._();
  @$core.pragma('dart2js:noInline')
  static FeedExtInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FeedExtInfo>(
          FeedExtInfo.$_createMessage);

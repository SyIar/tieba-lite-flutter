...
class Advertisement extends $pb.GeneratedMessage {
  ...
  factory Advertisement.fromBuffer($core.List<$core.int> data,
      ...
      Advertisement()..mergeFromBuffer(data, registry);
  factory Advertisement.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Advertisement()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Advertisement',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Advertisement.$_createMessage)
  ...
  @$core.Deprecated('Use Advertisement() / Advertisement.new instead')
  static Advertisement create() => Advertisement._();
  static $pb.GeneratedMessage $_createMessage() => Advertisement._();
  @$core.override
  Advertisement createEmptyInstance() => Advertisement._();
  @$core.pragma('dart2js:noInline')
  static Advertisement getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Advertisement>(
          Advertisement.$_createMessage);

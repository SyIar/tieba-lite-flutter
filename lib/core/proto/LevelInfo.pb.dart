...
class LevelInfo extends $pb.GeneratedMessage {
  ...
  factory LevelInfo.fromBuffer($core.List<$core.int> data,
      ...
      LevelInfo()..mergeFromBuffer(data, registry);
  factory LevelInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      LevelInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LevelInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: LevelInfo.$_createMessage)
  ...
  @$core.Deprecated('Use LevelInfo() / LevelInfo.new instead')
  static LevelInfo create() => LevelInfo._();
  static $pb.GeneratedMessage $_createMessage() => LevelInfo._();
  @$core.override
  LevelInfo createEmptyInstance() => LevelInfo._();
  @$core.pragma('dart2js:noInline')
  static LevelInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LevelInfo>(LevelInfo.$_createMessage);

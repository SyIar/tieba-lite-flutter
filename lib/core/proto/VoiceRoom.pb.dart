...
class VoiceRoom extends $pb.GeneratedMessage {
  ...
  factory VoiceRoom.fromBuffer($core.List<$core.int> data,
      ...
      VoiceRoom()..mergeFromBuffer(data, registry);
  factory VoiceRoom.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      VoiceRoom()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'VoiceRoom',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: VoiceRoom.$_createMessage)
  ...
  @$core.Deprecated('Use VoiceRoom() / VoiceRoom.new instead')
  static VoiceRoom create() => VoiceRoom._();
  static $pb.GeneratedMessage $_createMessage() => VoiceRoom._();
  @$core.override
  VoiceRoom createEmptyInstance() => VoiceRoom._();
  @$core.pragma('dart2js:noInline')
  static VoiceRoom getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VoiceRoom>(VoiceRoom.$_createMessage);

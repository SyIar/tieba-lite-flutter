...
class GuessLikeThreadInfo extends $pb.GeneratedMessage {
  factory GuessLikeThreadInfo({
    ...
    final result = GuessLikeThreadInfo._();
  ...
  factory GuessLikeThreadInfo.fromBuffer($core.List<$core.int> data,
      ...
      GuessLikeThreadInfo()..mergeFromBuffer(data, registry);
  factory GuessLikeThreadInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GuessLikeThreadInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GuessLikeThreadInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: GuessLikeThreadInfo.$_createMessage)
  ...
  @$core
      .Deprecated('Use GuessLikeThreadInfo() / GuessLikeThreadInfo.new instead')
  static GuessLikeThreadInfo create() => GuessLikeThreadInfo._();
  static $pb.GeneratedMessage $_createMessage() => GuessLikeThreadInfo._();
  @$core.override
  GuessLikeThreadInfo createEmptyInstance() => GuessLikeThreadInfo._();
  @$core.pragma('dart2js:noInline')
  static GuessLikeThreadInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GuessLikeThreadInfo>(
          GuessLikeThreadInfo.$_createMessage);

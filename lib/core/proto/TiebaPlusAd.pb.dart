...
class TiebaPlusAd extends $pb.GeneratedMessage {
  ...
  factory TiebaPlusAd.fromBuffer($core.List<$core.int> data,
      ...
      TiebaPlusAd()..mergeFromBuffer(data, registry);
  factory TiebaPlusAd.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      TiebaPlusAd()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TiebaPlusAd',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: TiebaPlusAd.$_createMessage)
  ...
  @$core.Deprecated('Use TiebaPlusAd() / TiebaPlusAd.new instead')
  static TiebaPlusAd create() => TiebaPlusAd._();
  static $pb.GeneratedMessage $_createMessage() => TiebaPlusAd._();
  @$core.override
  TiebaPlusAd createEmptyInstance() => TiebaPlusAd._();
  @$core.pragma('dart2js:noInline')
  static TiebaPlusAd getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TiebaPlusAd>(
          TiebaPlusAd.$_createMessage);

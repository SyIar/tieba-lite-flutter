...
class GetBawuInfoResponseData extends $pb.GeneratedMessage {
  factory GetBawuInfoResponseData({
    ...
    final result = GetBawuInfoResponseData._();
  ...
  @$core.Deprecated(
      'Use GetBawuInfoResponseData() / GetBawuInfoResponseData.new instead')
  static GetBawuInfoResponseData create() => GetBawuInfoResponseData._();
  static $pb.GeneratedMessage $_createMessage() => GetBawuInfoResponseData._();
  @$core.override
  GetBawuInfoResponseData createEmptyInstance() => GetBawuInfoResponseData._();
  @$core.pragma('dart2js:noInline')
  static GetBawuInfoResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetBawuInfoResponseData>(
          GetBawuInfoResponseData.$_createMessage);

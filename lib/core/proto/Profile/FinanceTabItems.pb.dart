...
class FinanceTabItems extends $pb.GeneratedMessage {
  factory FinanceTabItems({
    ...
    final result = FinanceTabItems._();
  ...
  @$core.Deprecated('Use FinanceTabItems() / FinanceTabItems.new instead')
  static FinanceTabItems create() => FinanceTabItems._();
  static $pb.GeneratedMessage $_createMessage() => FinanceTabItems._();
  @$core.override
  FinanceTabItems createEmptyInstance() => FinanceTabItems._();
  @$core.pragma('dart2js:noInline')
  static FinanceTabItems getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FinanceTabItems>(
          FinanceTabItems.$_createMessage);

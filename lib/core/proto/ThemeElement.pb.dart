...
class ThemeElement extends $pb.GeneratedMessage {
  ...
  factory ThemeElement.fromBuffer($core.List<$core.int> data,
      ...
      ThemeElement()..mergeFromBuffer(data, registry);
  factory ThemeElement.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThemeElement()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThemeElement',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ThemeElement.$_createMessage)
  ...
  @$core.Deprecated('Use ThemeElement() / ThemeElement.new instead')
  static ThemeElement create() => ThemeElement._();
  static $pb.GeneratedMessage $_createMessage() => ThemeElement._();
  @$core.override
  ThemeElement createEmptyInstance() => ThemeElement._();
  @$core.pragma('dart2js:noInline')
  static ThemeElement getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThemeElement>(
          ThemeElement.$_createMessage);

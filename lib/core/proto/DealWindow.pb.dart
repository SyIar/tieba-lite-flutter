...
class DealWindow extends $pb.GeneratedMessage {
  ...
  factory DealWindow.fromBuffer($core.List<$core.int> data,
      ...
      DealWindow()..mergeFromBuffer(data, registry);
  factory DealWindow.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      DealWindow()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DealWindow',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: DealWindow.$_createMessage)
    ..pPM<$0.DisplayWindowInfo>(1, _omitFieldNames ? '' : 'list',
        subBuilder: $0.DisplayWindowInfo.$_createMessage)
  ...
  @$core.Deprecated('Use DealWindow() / DealWindow.new instead')
  static DealWindow create() => DealWindow._();
  static $pb.GeneratedMessage $_createMessage() => DealWindow._();
  @$core.override
  DealWindow createEmptyInstance() => DealWindow._();
  @$core.pragma('dart2js:noInline')
  static DealWindow getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DealWindow>(DealWindow.$_createMessage);

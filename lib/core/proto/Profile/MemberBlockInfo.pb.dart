...
class MemberBlockInfo extends $pb.GeneratedMessage {
  factory MemberBlockInfo({
    ...
    final result = MemberBlockInfo._();
  ...
  @$core.Deprecated('Use MemberBlockInfo() / MemberBlockInfo.new instead')
  static MemberBlockInfo create() => MemberBlockInfo._();
  static $pb.GeneratedMessage $_createMessage() => MemberBlockInfo._();
  @$core.override
  MemberBlockInfo createEmptyInstance() => MemberBlockInfo._();
  @$core.pragma('dart2js:noInline')
  static MemberBlockInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MemberBlockInfo>(
          MemberBlockInfo.$_createMessage);

...
class HistoryForumInfo extends $pb.GeneratedMessage {
  factory HistoryForumInfo({
    ...
    final result = HistoryForumInfo._();
  ...
  factory HistoryForumInfo.fromBuffer($core.List<$core.int> data,
      ...
      HistoryForumInfo()..mergeFromBuffer(data, registry);
  factory HistoryForumInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      HistoryForumInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'HistoryForumInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: HistoryForumInfo.$_createMessage)
    ...
    ..aOM<$0.ThemeColorInfo>(8, _omitFieldNames ? '' : 'themeColor',
        subBuilder: $0.ThemeColorInfo.$_createMessage)
    ..aOB(10, _omitFieldNames ? '' : 'needTrans')
    ..aOM<$1.BlockPopInfo>(14, _omitFieldNames ? '' : 'blockPopInfo',
        subBuilder: $1.BlockPopInfo.$_createMessage)
  ...
  @$core.Deprecated('Use HistoryForumInfo() / HistoryForumInfo.new instead')
  static HistoryForumInfo create() => HistoryForumInfo._();
  static $pb.GeneratedMessage $_createMessage() => HistoryForumInfo._();
  @$core.override
  HistoryForumInfo createEmptyInstance() => HistoryForumInfo._();
  @$core.pragma('dart2js:noInline')
  static HistoryForumInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HistoryForumInfo>(
          HistoryForumInfo.$_createMessage);

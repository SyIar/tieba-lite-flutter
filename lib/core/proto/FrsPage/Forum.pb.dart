...
class Forum extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use Forum() / Forum.new instead')
  static Forum create() => Forum._();
  static $pb.GeneratedMessage $_createMessage() => Forum._();
  @$core.override
  Forum createEmptyInstance() => Forum._();
  @$core.pragma('dart2js:noInline')
  static Forum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Forum>(Forum.$_createMessage);

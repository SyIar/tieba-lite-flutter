...
class BawuRoleInfoPub extends $pb.GeneratedMessage {
  factory BawuRoleInfoPub({
    ...
    final result = BawuRoleInfoPub._();
  ...
  factory BawuRoleInfoPub.fromBuffer($core.List<$core.int> data,
      ...
      BawuRoleInfoPub()..mergeFromBuffer(data, registry);
  factory BawuRoleInfoPub.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BawuRoleInfoPub()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BawuRoleInfoPub',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BawuRoleInfoPub.$_createMessage)
    ...
    ..aOM<$0.BaijiahaoInfo>(10, _omitFieldNames ? '' : 'baijiahaoInfo',
        subBuilder: $0.BaijiahaoInfo.$_createMessage)
  ...
  @$core.Deprecated('Use BawuRoleInfoPub() / BawuRoleInfoPub.new instead')
  static BawuRoleInfoPub create() => BawuRoleInfoPub._();
  static $pb.GeneratedMessage $_createMessage() => BawuRoleInfoPub._();
  @$core.override
  BawuRoleInfoPub createEmptyInstance() => BawuRoleInfoPub._();
  @$core.pragma('dart2js:noInline')
  static BawuRoleInfoPub getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BawuRoleInfoPub>(
          BawuRoleInfoPub.$_createMessage);

...
class GodInfo extends $pb.GeneratedMessage {
  ...
  factory GodInfo.fromBuffer($core.List<$core.int> data,
      ...
      GodInfo()..mergeFromBuffer(data, registry);
  factory GodInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GodInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GodInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: GodInfo.$_createMessage)
  ...
  @$core.Deprecated('Use GodInfo() / GodInfo.new instead')
  static GodInfo create() => GodInfo._();
  static $pb.GeneratedMessage $_createMessage() => GodInfo._();
  @$core.override
  GodInfo createEmptyInstance() => GodInfo._();
  @$core.pragma('dart2js:noInline')
  static GodInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GodInfo>(GodInfo.$_createMessage);

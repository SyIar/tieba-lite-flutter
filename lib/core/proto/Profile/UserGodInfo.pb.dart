...
class UserGodInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use UserGodInfo() / UserGodInfo.new instead')
  static UserGodInfo create() => UserGodInfo._();
  static $pb.GeneratedMessage $_createMessage() => UserGodInfo._();
  @$core.override
  UserGodInfo createEmptyInstance() => UserGodInfo._();
  @$core.pragma('dart2js:noInline')
  static UserGodInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserGodInfo>(
          UserGodInfo.$_createMessage);

...
class Baijiahao extends $pb.GeneratedMessage {
  ...
  factory Baijiahao.fromBuffer($core.List<$core.int> data,
      ...
      Baijiahao()..mergeFromBuffer(data, registry);
  factory Baijiahao.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Baijiahao()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Baijiahao',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Baijiahao.$_createMessage)
  ...
  @$core.Deprecated('Use Baijiahao() / Baijiahao.new instead')
  static Baijiahao create() => Baijiahao._();
  static $pb.GeneratedMessage $_createMessage() => Baijiahao._();
  @$core.override
  Baijiahao createEmptyInstance() => Baijiahao._();
  @$core.pragma('dart2js:noInline')
  static Baijiahao getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Baijiahao>(Baijiahao.$_createMessage);

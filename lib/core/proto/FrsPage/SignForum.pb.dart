...
class SignForum extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use SignForum() / SignForum.new instead')
  static SignForum create() => SignForum._();
  static $pb.GeneratedMessage $_createMessage() => SignForum._();
  @$core.override
  SignForum createEmptyInstance() => SignForum._();
  @$core.pragma('dart2js:noInline')
  static SignForum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SignForum>(SignForum.$_createMessage);

...
class SignatureData extends $pb.GeneratedMessage {
  ...
  factory SignatureData.fromBuffer($core.List<$core.int> data,
      ...
      SignatureData()..mergeFromBuffer(data, registry);
  factory SignatureData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      SignatureData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SignatureData',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: SignatureData.$_createMessage)
    ...
    ..pPM<$0.SignatureContent>(4, _omitFieldNames ? '' : 'content',
        subBuilder: $0.SignatureContent.$_createMessage)
  ...
  @$core.Deprecated('Use SignatureData() / SignatureData.new instead')
  static SignatureData create() => SignatureData._();
  static $pb.GeneratedMessage $_createMessage() => SignatureData._();
  @$core.override
  SignatureData createEmptyInstance() => SignatureData._();
  @$core.pragma('dart2js:noInline')
  static SignatureData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SignatureData>(
          SignatureData.$_createMessage);

...
class UserPostPerm extends $pb.GeneratedMessage {
  ...
  factory UserPostPerm.fromBuffer($core.List<$core.int> data,
      ...
      UserPostPerm()..mergeFromBuffer(data, registry);
  factory UserPostPerm.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserPostPerm()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserPostPerm',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: UserPostPerm.$_createMessage)
  ...
  @$core.Deprecated('Use UserPostPerm() / UserPostPerm.new instead')
  static UserPostPerm create() => UserPostPerm._();
  static $pb.GeneratedMessage $_createMessage() => UserPostPerm._();
  @$core.override
  UserPostPerm createEmptyInstance() => UserPostPerm._();
  @$core.pragma('dart2js:noInline')
  static UserPostPerm getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserPostPerm>(
          UserPostPerm.$_createMessage);

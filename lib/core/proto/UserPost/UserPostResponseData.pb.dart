...
class UserPostResponseData extends $pb.GeneratedMessage {
  factory UserPostResponseData({
    ...
    final result = UserPostResponseData._();
  ...
  @$core.Deprecated(
      'Use UserPostResponseData() / UserPostResponseData.new instead')
  static UserPostResponseData create() => UserPostResponseData._();
  static $pb.GeneratedMessage $_createMessage() => UserPostResponseData._();
  @$core.override
  UserPostResponseData createEmptyInstance() => UserPostResponseData._();
  @$core.pragma('dart2js:noInline')
  static UserPostResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserPostResponseData>(
          UserPostResponseData.$_createMessage);

...
class PbFloorResponse extends $pb.GeneratedMessage {
  factory PbFloorResponse({
    ...
    final result = PbFloorResponse._();
  ...
  @$core.Deprecated('Use PbFloorResponse() / PbFloorResponse.new instead')
  static PbFloorResponse create() => PbFloorResponse._();
  static $pb.GeneratedMessage $_createMessage() => PbFloorResponse._();
  @$core.override
  PbFloorResponse createEmptyInstance() => PbFloorResponse._();
  @$core.pragma('dart2js:noInline')
  static PbFloorResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbFloorResponse>(
          PbFloorResponse.$_createMessage);

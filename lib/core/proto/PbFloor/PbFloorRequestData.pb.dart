...
class PbFloorRequestData extends $pb.GeneratedMessage {
  factory PbFloorRequestData({
    ...
    final result = PbFloorRequestData._();
  ...
  @$core.Deprecated('Use PbFloorRequestData() / PbFloorRequestData.new instead')
  static PbFloorRequestData create() => PbFloorRequestData._();
  static $pb.GeneratedMessage $_createMessage() => PbFloorRequestData._();
  @$core.override
  PbFloorRequestData createEmptyInstance() => PbFloorRequestData._();
  @$core.pragma('dart2js:noInline')
  static PbFloorRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbFloorRequestData>(
          PbFloorRequestData.$_createMessage);

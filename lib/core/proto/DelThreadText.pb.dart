...
class DelThreadText extends $pb.GeneratedMessage {
  ...
  factory DelThreadText.fromBuffer($core.List<$core.int> data,
      ...
      DelThreadText()..mergeFromBuffer(data, registry);
  factory DelThreadText.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      DelThreadText()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DelThreadText',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: DelThreadText.$_createMessage)
  ...
  @$core.Deprecated('Use DelThreadText() / DelThreadText.new instead')
  static DelThreadText create() => DelThreadText._();
  static $pb.GeneratedMessage $_createMessage() => DelThreadText._();
  @$core.override
  DelThreadText createEmptyInstance() => DelThreadText._();
  @$core.pragma('dart2js:noInline')
  static DelThreadText getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DelThreadText>(
          DelThreadText.$_createMessage);

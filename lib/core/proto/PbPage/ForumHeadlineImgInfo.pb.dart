...
class ForumHeadlineImgInfo extends $pb.GeneratedMessage {
  factory ForumHeadlineImgInfo({
    ...
    final result = ForumHeadlineImgInfo._();
  ...
  @$core.Deprecated(
      'Use ForumHeadlineImgInfo() / ForumHeadlineImgInfo.new instead')
  static ForumHeadlineImgInfo create() => ForumHeadlineImgInfo._();
  static $pb.GeneratedMessage $_createMessage() => ForumHeadlineImgInfo._();
  @$core.override
  ForumHeadlineImgInfo createEmptyInstance() => ForumHeadlineImgInfo._();
  @$core.pragma('dart2js:noInline')
  static ForumHeadlineImgInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForumHeadlineImgInfo>(
          ForumHeadlineImgInfo.$_createMessage);

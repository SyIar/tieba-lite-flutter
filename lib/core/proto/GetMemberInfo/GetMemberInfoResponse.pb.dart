...
class GetMemberInfoResponse extends $pb.GeneratedMessage {
  factory GetMemberInfoResponse({
    ...
    final result = GetMemberInfoResponse._();
  ...
  @$core.Deprecated(
      'Use GetMemberInfoResponse() / GetMemberInfoResponse.new instead')
  static GetMemberInfoResponse create() => GetMemberInfoResponse._();
  static $pb.GeneratedMessage $_createMessage() => GetMemberInfoResponse._();
  @$core.override
  GetMemberInfoResponse createEmptyInstance() => GetMemberInfoResponse._();
  @$core.pragma('dart2js:noInline')
  static GetMemberInfoResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetMemberInfoResponse>(
          GetMemberInfoResponse.$_createMessage);

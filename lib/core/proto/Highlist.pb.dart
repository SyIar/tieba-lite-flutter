...
class Highlist extends $pb.GeneratedMessage {
  ...
  factory Highlist.fromBuffer($core.List<$core.int> data,
      ...
      Highlist()..mergeFromBuffer(data, registry);
  factory Highlist.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Highlist()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Highlist',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Highlist.$_createMessage)
    ..pPM<$0.High>(1, _omitFieldNames ? '' : 'list',
        subBuilder: $0.High.$_createMessage)
  ...
  @$core.Deprecated('Use Highlist() / Highlist.new instead')
  static Highlist create() => Highlist._();
  static $pb.GeneratedMessage $_createMessage() => Highlist._();
  @$core.override
  Highlist createEmptyInstance() => Highlist._();
  @$core.pragma('dart2js:noInline')
  static Highlist getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Highlist>(Highlist.$_createMessage);

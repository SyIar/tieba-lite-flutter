...
class DealAuthInfo extends $pb.GeneratedMessage {
  ...
  factory DealAuthInfo.fromBuffer($core.List<$core.int> data,
      ...
      DealAuthInfo()..mergeFromBuffer(data, registry);
  factory DealAuthInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      DealAuthInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DealAuthInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: DealAuthInfo.$_createMessage)
  ...
  @$core.Deprecated('Use DealAuthInfo() / DealAuthInfo.new instead')
  static DealAuthInfo create() => DealAuthInfo._();
  static $pb.GeneratedMessage $_createMessage() => DealAuthInfo._();
  @$core.override
  DealAuthInfo createEmptyInstance() => DealAuthInfo._();
  @$core.pragma('dart2js:noInline')
  static DealAuthInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DealAuthInfo>(
          DealAuthInfo.$_createMessage);

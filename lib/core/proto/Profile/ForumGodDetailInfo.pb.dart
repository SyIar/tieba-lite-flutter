...
class ForumGodDetailInfo extends $pb.GeneratedMessage {
  factory ForumGodDetailInfo({
    ...
    final result = ForumGodDetailInfo._();
  ...
  @$core.Deprecated('Use ForumGodDetailInfo() / ForumGodDetailInfo.new instead')
  static ForumGodDetailInfo create() => ForumGodDetailInfo._();
  static $pb.GeneratedMessage $_createMessage() => ForumGodDetailInfo._();
  @$core.override
  ForumGodDetailInfo createEmptyInstance() => ForumGodDetailInfo._();
  @$core.pragma('dart2js:noInline')
  static ForumGodDetailInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForumGodDetailInfo>(
          ForumGodDetailInfo.$_createMessage);

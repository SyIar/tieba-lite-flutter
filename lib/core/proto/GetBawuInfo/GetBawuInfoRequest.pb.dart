...
class GetBawuInfoRequest extends $pb.GeneratedMessage {
  factory GetBawuInfoRequest({
    ...
    final result = GetBawuInfoRequest._();
  ...
  @$core.Deprecated('Use GetBawuInfoRequest() / GetBawuInfoRequest.new instead')
  static GetBawuInfoRequest create() => GetBawuInfoRequest._();
  static $pb.GeneratedMessage $_createMessage() => GetBawuInfoRequest._();
  @$core.override
  GetBawuInfoRequest createEmptyInstance() => GetBawuInfoRequest._();
  @$core.pragma('dart2js:noInline')
  static GetBawuInfoRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetBawuInfoRequest>(
          GetBawuInfoRequest.$_createMessage);

...
class PbPageResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use PbPageResponse() / PbPageResponse.new instead')
  static PbPageResponse create() => PbPageResponse._();
  static $pb.GeneratedMessage $_createMessage() => PbPageResponse._();
  @$core.override
  PbPageResponse createEmptyInstance() => PbPageResponse._();
  @$core.pragma('dart2js:noInline')
  static PbPageResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbPageResponse>(
          PbPageResponse.$_createMessage);

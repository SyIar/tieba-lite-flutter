...
class ForumRuleDetailResponse extends $pb.GeneratedMessage {
  factory ForumRuleDetailResponse({
    ...
    final result = ForumRuleDetailResponse._();
  ...
  factory ForumRuleDetailResponse.fromBuffer($core.List<$core.int> data,
      ...
      ForumRuleDetailResponse()..mergeFromBuffer(data, registry);
  factory ForumRuleDetailResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumRuleDetailResponse()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumRuleDetailResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.forumRuleDetail'),
      createEmptyInstance: ForumRuleDetailResponse.$_createMessage)
    ...
    ..aOM<$1.ForumRuleDetailResponseData>(2, _omitFieldNames ? '' : 'data',
        subBuilder: $1.ForumRuleDetailResponseData.$_createMessage)
  ...
  @$core.Deprecated(
      'Use ForumRuleDetailResponse() / ForumRuleDetailResponse.new instead')
  static ForumRuleDetailResponse create() => ForumRuleDetailResponse._();
  static $pb.GeneratedMessage $_createMessage() => ForumRuleDetailResponse._();
  @$core.override
  ForumRuleDetailResponse createEmptyInstance() => ForumRuleDetailResponse._();
  @$core.pragma('dart2js:noInline')
  static ForumRuleDetailResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForumRuleDetailResponse>(
          ForumRuleDetailResponse.$_createMessage);

...
class FeedForumInfo extends $pb.GeneratedMessage {
  ...
  factory FeedForumInfo.fromBuffer($core.List<$core.int> data,
      ...
      FeedForumInfo()..mergeFromBuffer(data, registry);
  factory FeedForumInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FeedForumInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FeedForumInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: FeedForumInfo.$_createMessage)
  ...
  @$core.Deprecated('Use FeedForumInfo() / FeedForumInfo.new instead')
  static FeedForumInfo create() => FeedForumInfo._();
  static $pb.GeneratedMessage $_createMessage() => FeedForumInfo._();
  @$core.override
  FeedForumInfo createEmptyInstance() => FeedForumInfo._();
  @$core.pragma('dart2js:noInline')
  static FeedForumInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FeedForumInfo>(
          FeedForumInfo.$_createMessage);

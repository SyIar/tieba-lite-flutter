...
class ForumMemberInfo extends $pb.GeneratedMessage {
  factory ForumMemberInfo({
    ...
    final result = ForumMemberInfo._();
  ...
  factory ForumMemberInfo.fromBuffer($core.List<$core.int> data,
      ...
      ForumMemberInfo()..mergeFromBuffer(data, registry);
  factory ForumMemberInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumMemberInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumMemberInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ForumMemberInfo.$_createMessage)
  ...
  @$core.Deprecated('Use ForumMemberInfo() / ForumMemberInfo.new instead')
  static ForumMemberInfo create() => ForumMemberInfo._();
  static $pb.GeneratedMessage $_createMessage() => ForumMemberInfo._();
  @$core.override
  ForumMemberInfo createEmptyInstance() => ForumMemberInfo._();
  @$core.pragma('dart2js:noInline')
  static ForumMemberInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ForumMemberInfo>(
          ForumMemberInfo.$_createMessage);

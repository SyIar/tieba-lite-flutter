...
class PostInfoContent extends $pb.GeneratedMessage {
  factory PostInfoContent({
    ...
    final result = PostInfoContent._();
  ...
  factory PostInfoContent.fromBuffer($core.List<$core.int> data,
      ...
      PostInfoContent()..mergeFromBuffer(data, registry);
  factory PostInfoContent.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PostInfoContent()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PostInfoContent',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PostInfoContent.$_createMessage)
  ...
  @$core.Deprecated('Use PostInfoContent() / PostInfoContent.new instead')
  static PostInfoContent create() => PostInfoContent._();
  static $pb.GeneratedMessage $_createMessage() => PostInfoContent._();
  @$core.override
  PostInfoContent createEmptyInstance() => PostInfoContent._();
  @$core.pragma('dart2js:noInline')
  static PostInfoContent getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PostInfoContent>(
          PostInfoContent.$_createMessage);

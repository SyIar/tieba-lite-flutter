...
class GodCard extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use GodCard() / GodCard.new instead')
  static GodCard create() => GodCard._();
  static $pb.GeneratedMessage $_createMessage() => GodCard._();
  @$core.override
  GodCard createEmptyInstance() => GodCard._();
  @$core.pragma('dart2js:noInline')
  static GodCard getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GodCard>(GodCard.$_createMessage);

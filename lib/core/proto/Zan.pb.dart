...
class Zan extends $pb.GeneratedMessage {
  ...
  factory Zan.fromBuffer($core.List<$core.int> data,
      ...
      Zan()..mergeFromBuffer(data, registry);
  factory Zan.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Zan()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Zan',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Zan.$_createMessage)
  ...
  @$core.Deprecated('Use Zan() / Zan.new instead')
  static Zan create() => Zan._();
  static $pb.GeneratedMessage $_createMessage() => Zan._();
  @$core.override
  Zan createEmptyInstance() => Zan._();
  @$core.pragma('dart2js:noInline')
  static Zan getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Zan>(Zan.$_createMessage);

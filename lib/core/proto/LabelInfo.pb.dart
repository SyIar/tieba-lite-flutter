...
class LabelInfo extends $pb.GeneratedMessage {
  ...
  factory LabelInfo.fromBuffer($core.List<$core.int> data,
      ...
      LabelInfo()..mergeFromBuffer(data, registry);
  factory LabelInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      LabelInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LabelInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: LabelInfo.$_createMessage)
  ...
  @$core.Deprecated('Use LabelInfo() / LabelInfo.new instead')
  static LabelInfo create() => LabelInfo._();
  static $pb.GeneratedMessage $_createMessage() => LabelInfo._();
  @$core.override
  LabelInfo createEmptyInstance() => LabelInfo._();
  @$core.pragma('dart2js:noInline')
  static LabelInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LabelInfo>(LabelInfo.$_createMessage);

...
class ForumDynamic extends $pb.GeneratedMessage {
  ...
  factory ForumDynamic.fromBuffer($core.List<$core.int> data,
      ...
      ForumDynamic()..mergeFromBuffer(data, registry);
  factory ForumDynamic.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumDynamic()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumDynamic',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ForumDynamic.$_createMessage)
  ...
  @$core.Deprecated('Use ForumDynamic() / ForumDynamic.new instead')
  static ForumDynamic create() => ForumDynamic._();
  static $pb.GeneratedMessage $_createMessage() => ForumDynamic._();
  @$core.override
  ForumDynamic createEmptyInstance() => ForumDynamic._();
  @$core.pragma('dart2js:noInline')
  static ForumDynamic getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ForumDynamic>(
          ForumDynamic.$_createMessage);

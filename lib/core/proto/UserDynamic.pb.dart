...
class UserDynamic extends $pb.GeneratedMessage {
  ...
  factory UserDynamic.fromBuffer($core.List<$core.int> data,
      ...
      UserDynamic()..mergeFromBuffer(data, registry);
  factory UserDynamic.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserDynamic()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserDynamic',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: UserDynamic.$_createMessage)
  ...
  @$core.Deprecated('Use UserDynamic() / UserDynamic.new instead')
  static UserDynamic create() => UserDynamic._();
  static $pb.GeneratedMessage $_createMessage() => UserDynamic._();
  @$core.override
  UserDynamic createEmptyInstance() => UserDynamic._();
  @$core.pragma('dart2js:noInline')
  static UserDynamic getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserDynamic>(
          UserDynamic.$_createMessage);

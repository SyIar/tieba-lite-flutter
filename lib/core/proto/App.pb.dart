...
class App extends $pb.GeneratedMessage {
  ...
  factory App.fromBuffer($core.List<$core.int> data,
      ...
      App()..mergeFromBuffer(data, registry);
  factory App.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      App()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'App',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: App.$_createMessage)
    ...
    ..pPM<$0.GoodsInfo>(30, _omitFieldNames ? '' : 'goodsInfo',
        subBuilder: $0.GoodsInfo.$_createMessage)
  ...
  @$core.Deprecated('Use App() / App.new instead')
  static App create() => App._();
  static $pb.GeneratedMessage $_createMessage() => App._();
  @$core.override
  App createEmptyInstance() => App._();
  @$core.pragma('dart2js:noInline')
  static App getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<App>(App.$_createMessage);

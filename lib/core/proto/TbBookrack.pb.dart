...
class TbBookrack extends $pb.GeneratedMessage {
  ...
  factory TbBookrack.fromBuffer($core.List<$core.int> data,
      ...
      TbBookrack()..mergeFromBuffer(data, registry);
  factory TbBookrack.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      TbBookrack()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TbBookrack',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: TbBookrack.$_createMessage)
    ...
    ..pPM<$0.BookInfo>(3, _omitFieldNames ? '' : 'bookList',
        subBuilder: $0.BookInfo.$_createMessage)
  ...
  @$core.Deprecated('Use TbBookrack() / TbBookrack.new instead')
  static TbBookrack create() => TbBookrack._();
  static $pb.GeneratedMessage $_createMessage() => TbBookrack._();
  @$core.override
  TbBookrack createEmptyInstance() => TbBookrack._();
  @$core.pragma('dart2js:noInline')
  static TbBookrack getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TbBookrack>(TbBookrack.$_createMessage);

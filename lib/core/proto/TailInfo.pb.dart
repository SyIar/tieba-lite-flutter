...
class TailInfo extends $pb.GeneratedMessage {
  ...
  factory TailInfo.fromBuffer($core.List<$core.int> data,
      ...
      TailInfo()..mergeFromBuffer(data, registry);
  factory TailInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      TailInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TailInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: TailInfo.$_createMessage)
  ...
  @$core.Deprecated('Use TailInfo() / TailInfo.new instead')
  static TailInfo create() => TailInfo._();
  static $pb.GeneratedMessage $_createMessage() => TailInfo._();
  @$core.override
  TailInfo createEmptyInstance() => TailInfo._();
  @$core.pragma('dart2js:noInline')
  static TailInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TailInfo>(TailInfo.$_createMessage);

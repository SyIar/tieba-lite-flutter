...
class PbFollowTip extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use PbFollowTip() / PbFollowTip.new instead')
  static PbFollowTip create() => PbFollowTip._();
  static $pb.GeneratedMessage $_createMessage() => PbFollowTip._();
  @$core.override
  PbFollowTip createEmptyInstance() => PbFollowTip._();
  @$core.pragma('dart2js:noInline')
  static PbFollowTip getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbFollowTip>(
          PbFollowTip.$_createMessage);

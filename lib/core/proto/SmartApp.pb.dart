...
class SmartApp extends $pb.GeneratedMessage {
  ...
  factory SmartApp.fromBuffer($core.List<$core.int> data,
      ...
      SmartApp()..mergeFromBuffer(data, registry);
  factory SmartApp.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      SmartApp()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SmartApp',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: SmartApp.$_createMessage)
  ...
  @$core.Deprecated('Use SmartApp() / SmartApp.new instead')
  static SmartApp create() => SmartApp._();
  static $pb.GeneratedMessage $_createMessage() => SmartApp._();
  @$core.override
  SmartApp createEmptyInstance() => SmartApp._();
  @$core.pragma('dart2js:noInline')
  static SmartApp getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SmartApp>(SmartApp.$_createMessage);

...
class NicknameInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use NicknameInfo() / NicknameInfo.new instead')
  static NicknameInfo create() => NicknameInfo._();
  static $pb.GeneratedMessage $_createMessage() => NicknameInfo._();
  @$core.override
  NicknameInfo createEmptyInstance() => NicknameInfo._();
  @$core.pragma('dart2js:noInline')
  static NicknameInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NicknameInfo>(
          NicknameInfo.$_createMessage);

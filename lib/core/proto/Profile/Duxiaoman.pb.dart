...
class Duxiaoman extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use Duxiaoman() / Duxiaoman.new instead')
  static Duxiaoman create() => Duxiaoman._();
  static $pb.GeneratedMessage $_createMessage() => Duxiaoman._();
  @$core.override
  Duxiaoman createEmptyInstance() => Duxiaoman._();
  @$core.pragma('dart2js:noInline')
  static Duxiaoman getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Duxiaoman>(Duxiaoman.$_createMessage);

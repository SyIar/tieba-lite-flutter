...
class ManagerApplyInfo extends $pb.GeneratedMessage {
  factory ManagerApplyInfo({
    ...
    final result = ManagerApplyInfo._();
  ...
  @$core.Deprecated('Use ManagerApplyInfo() / ManagerApplyInfo.new instead')
  static ManagerApplyInfo create() => ManagerApplyInfo._();
  static $pb.GeneratedMessage $_createMessage() => ManagerApplyInfo._();
  @$core.override
  ManagerApplyInfo createEmptyInstance() => ManagerApplyInfo._();
  @$core.pragma('dart2js:noInline')
  static ManagerApplyInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ManagerApplyInfo>(
          ManagerApplyInfo.$_createMessage);

...
class RecomTagInfo extends $pb.GeneratedMessage {
  ...
  factory RecomTagInfo.fromBuffer($core.List<$core.int> data,
      ...
      RecomTagInfo()..mergeFromBuffer(data, registry);
  factory RecomTagInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      RecomTagInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RecomTagInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: RecomTagInfo.$_createMessage)
  ...
  @$core.Deprecated('Use RecomTagInfo() / RecomTagInfo.new instead')
  static RecomTagInfo create() => RecomTagInfo._();
  static $pb.GeneratedMessage $_createMessage() => RecomTagInfo._();
  @$core.override
  RecomTagInfo createEmptyInstance() => RecomTagInfo._();
  @$core.pragma('dart2js:noInline')
  static RecomTagInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecomTagInfo>(
          RecomTagInfo.$_createMessage);

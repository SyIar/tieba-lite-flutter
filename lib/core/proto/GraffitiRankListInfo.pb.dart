...
class GraffitiRankListInfo extends $pb.GeneratedMessage {
  factory GraffitiRankListInfo({
    ...
    final result = GraffitiRankListInfo._();
  ...
  factory GraffitiRankListInfo.fromBuffer($core.List<$core.int> data,
      ...
      GraffitiRankListInfo()..mergeFromBuffer(data, registry);
  factory GraffitiRankListInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GraffitiRankListInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GraffitiRankListInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: GraffitiRankListInfo.$_createMessage)
    ..aI(1, _omitFieldNames ? '' : 'hasMore')
    ..aI(2, _omitFieldNames ? '' : 'total')
    ..pPM<$0.GraffitiRankItem>(3, _omitFieldNames ? '' : 'list',
        subBuilder: $0.GraffitiRankItem.$_createMessage)
  ...
  @$core.Deprecated(
      'Use GraffitiRankListInfo() / GraffitiRankListInfo.new instead')
  static GraffitiRankListInfo create() => GraffitiRankListInfo._();
  static $pb.GeneratedMessage $_createMessage() => GraffitiRankListInfo._();
  @$core.override
  GraffitiRankListInfo createEmptyInstance() => GraffitiRankListInfo._();
  @$core.pragma('dart2js:noInline')
  static GraffitiRankListInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GraffitiRankListInfo>(
          GraffitiRankListInfo.$_createMessage);

...
class MemberGroupInfo extends $pb.GeneratedMessage {
  factory MemberGroupInfo({
    ...
    final result = MemberGroupInfo._();
  ...
  factory MemberGroupInfo.fromBuffer($core.List<$core.int> data,
      ...
      MemberGroupInfo()..mergeFromBuffer(data, registry);
  factory MemberGroupInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      MemberGroupInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MemberGroupInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: MemberGroupInfo.$_createMessage)
    ...
    ..pPM<$0.BawuRoleInfoPub>(3, _omitFieldNames ? '' : 'memberGroupList',
        subBuilder: $0.BawuRoleInfoPub.$_createMessage)
  ...
  @$core.Deprecated('Use MemberGroupInfo() / MemberGroupInfo.new instead')
  static MemberGroupInfo create() => MemberGroupInfo._();
  static $pb.GeneratedMessage $_createMessage() => MemberGroupInfo._();
  @$core.override
  MemberGroupInfo createEmptyInstance() => MemberGroupInfo._();
  @$core.pragma('dart2js:noInline')
  static MemberGroupInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MemberGroupInfo>(
          MemberGroupInfo.$_createMessage);

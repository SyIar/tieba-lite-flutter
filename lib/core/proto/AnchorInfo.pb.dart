...
class AnchorInfo extends $pb.GeneratedMessage {
  ...
  factory AnchorInfo.fromBuffer($core.List<$core.int> data,
      ...
      AnchorInfo()..mergeFromBuffer(data, registry);
  factory AnchorInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AnchorInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AnchorInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AnchorInfo.$_createMessage)
  ...
  @$core.Deprecated('Use AnchorInfo() / AnchorInfo.new instead')
  static AnchorInfo create() => AnchorInfo._();
  static $pb.GeneratedMessage $_createMessage() => AnchorInfo._();
  @$core.override
  AnchorInfo createEmptyInstance() => AnchorInfo._();
  @$core.pragma('dart2js:noInline')
  static AnchorInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AnchorInfo>(AnchorInfo.$_createMessage);

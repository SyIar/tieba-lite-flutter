...
class SearchSugRequestData extends $pb.GeneratedMessage {
  factory SearchSugRequestData({
    ...
    final result = SearchSugRequestData._();
  ...
  @$core.Deprecated(
      'Use SearchSugRequestData() / SearchSugRequestData.new instead')
  static SearchSugRequestData create() => SearchSugRequestData._();
  static $pb.GeneratedMessage $_createMessage() => SearchSugRequestData._();
  @$core.override
  SearchSugRequestData createEmptyInstance() => SearchSugRequestData._();
  @$core.pragma('dart2js:noInline')
  static SearchSugRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SearchSugRequestData>(
          SearchSugRequestData.$_createMessage);

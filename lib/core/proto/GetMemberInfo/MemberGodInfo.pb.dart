...
class MemberGodInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use MemberGodInfo() / MemberGodInfo.new instead')
  static MemberGodInfo create() => MemberGodInfo._();
  static $pb.GeneratedMessage $_createMessage() => MemberGodInfo._();
  @$core.override
  MemberGodInfo createEmptyInstance() => MemberGodInfo._();
  @$core.pragma('dart2js:noInline')
  static MemberGodInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MemberGodInfo>(
          MemberGodInfo.$_createMessage);

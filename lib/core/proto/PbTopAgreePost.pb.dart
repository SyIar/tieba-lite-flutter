...
class PbTopAgreePost extends $pb.GeneratedMessage {
  ...
  factory PbTopAgreePost.fromBuffer($core.List<$core.int> data,
      ...
      PbTopAgreePost()..mergeFromBuffer(data, registry);
  factory PbTopAgreePost.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PbTopAgreePost()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PbTopAgreePost',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PbTopAgreePost.$_createMessage)
    ..pPM<$0.Post>(1, _omitFieldNames ? '' : 'postList',
        subBuilder: $0.Post.$_createMessage)
    ..p<$fixnum.Int64>(
  ...
  @$core.Deprecated('Use PbTopAgreePost() / PbTopAgreePost.new instead')
  static PbTopAgreePost create() => PbTopAgreePost._();
  static $pb.GeneratedMessage $_createMessage() => PbTopAgreePost._();
  @$core.override
  PbTopAgreePost createEmptyInstance() => PbTopAgreePost._();
  @$core.pragma('dart2js:noInline')
  static PbTopAgreePost getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbTopAgreePost>(
          PbTopAgreePost.$_createMessage);

...
class BawuRoleDes extends $pb.GeneratedMessage {
  ...
  factory BawuRoleDes.fromBuffer($core.List<$core.int> data,
      ...
      BawuRoleDes()..mergeFromBuffer(data, registry);
  factory BawuRoleDes.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BawuRoleDes()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BawuRoleDes',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BawuRoleDes.$_createMessage)
  ...
  @$core.Deprecated('Use BawuRoleDes() / BawuRoleDes.new instead')
  static BawuRoleDes create() => BawuRoleDes._();
  static $pb.GeneratedMessage $_createMessage() => BawuRoleDes._();
  @$core.override
  BawuRoleDes createEmptyInstance() => BawuRoleDes._();
  @$core.pragma('dart2js:noInline')
  static BawuRoleDes getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BawuRoleDes>(
          BawuRoleDes.$_createMessage);

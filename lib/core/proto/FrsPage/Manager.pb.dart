...
class Manager extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use Manager() / Manager.new instead')
  static Manager create() => Manager._();
  static $pb.GeneratedMessage $_createMessage() => Manager._();
  @$core.override
  Manager createEmptyInstance() => Manager._();
  @$core.pragma('dart2js:noInline')
  static Manager getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Manager>(Manager.$_createMessage);

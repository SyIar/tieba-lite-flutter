...
class BookTag extends $pb.GeneratedMessage {
  ...
  factory BookTag.fromBuffer($core.List<$core.int> data,
      ...
      BookTag()..mergeFromBuffer(data, registry);
  factory BookTag.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BookTag()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BookTag',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BookTag.$_createMessage)
  ...
  @$core.Deprecated('Use BookTag() / BookTag.new instead')
  static BookTag create() => BookTag._();
  static $pb.GeneratedMessage $_createMessage() => BookTag._();
  @$core.override
  BookTag createEmptyInstance() => BookTag._();
  @$core.pragma('dart2js:noInline')
  static BookTag getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BookTag>(BookTag.$_createMessage);

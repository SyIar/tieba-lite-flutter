...
class GetLevelInfoRequest extends $pb.GeneratedMessage {
  factory GetLevelInfoRequest({
    ...
    final result = GetLevelInfoRequest._();
  ...
  @$core
      .Deprecated('Use GetLevelInfoRequest() / GetLevelInfoRequest.new instead')
  static GetLevelInfoRequest create() => GetLevelInfoRequest._();
  static $pb.GeneratedMessage $_createMessage() => GetLevelInfoRequest._();
  @$core.override
  GetLevelInfoRequest createEmptyInstance() => GetLevelInfoRequest._();
  @$core.pragma('dart2js:noInline')
  static GetLevelInfoRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetLevelInfoRequest>(
          GetLevelInfoRequest.$_createMessage);

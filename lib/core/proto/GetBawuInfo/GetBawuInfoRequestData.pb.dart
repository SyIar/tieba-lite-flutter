...
class GetBawuInfoRequestData extends $pb.GeneratedMessage {
  factory GetBawuInfoRequestData({
    ...
    final result = GetBawuInfoRequestData._();
  ...
  @$core.Deprecated(
      'Use GetBawuInfoRequestData() / GetBawuInfoRequestData.new instead')
  static GetBawuInfoRequestData create() => GetBawuInfoRequestData._();
  static $pb.GeneratedMessage $_createMessage() => GetBawuInfoRequestData._();
  @$core.override
  GetBawuInfoRequestData createEmptyInstance() => GetBawuInfoRequestData._();
  @$core.pragma('dart2js:noInline')
  static GetBawuInfoRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetBawuInfoRequestData>(
          GetBawuInfoRequestData.$_createMessage);

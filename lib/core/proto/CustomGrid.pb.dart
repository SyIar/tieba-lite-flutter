...
class CustomGrid extends $pb.GeneratedMessage {
  ...
  factory CustomGrid.fromBuffer($core.List<$core.int> data,
      ...
      CustomGrid()..mergeFromBuffer(data, registry);
  factory CustomGrid.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      CustomGrid()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CustomGrid',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: CustomGrid.$_createMessage)
  ...
  @$core.Deprecated('Use CustomGrid() / CustomGrid.new instead')
  static CustomGrid create() => CustomGrid._();
  static $pb.GeneratedMessage $_createMessage() => CustomGrid._();
  @$core.override
  CustomGrid createEmptyInstance() => CustomGrid._();
  @$core.pragma('dart2js:noInline')
  static CustomGrid getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CustomGrid>(CustomGrid.$_createMessage);

...
class AppPosInfo extends $pb.GeneratedMessage {
  ...
  factory AppPosInfo.fromBuffer($core.List<$core.int> data,
      ...
      AppPosInfo()..mergeFromBuffer(data, registry);
  factory AppPosInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AppPosInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AppPosInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AppPosInfo.$_createMessage)
  ...
  @$core.Deprecated('Use AppPosInfo() / AppPosInfo.new instead')
  static AppPosInfo create() => AppPosInfo._();
  static $pb.GeneratedMessage $_createMessage() => AppPosInfo._();
  @$core.override
  AppPosInfo createEmptyInstance() => AppPosInfo._();
  @$core.pragma('dart2js:noInline')
  static AppPosInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AppPosInfo>(AppPosInfo.$_createMessage);

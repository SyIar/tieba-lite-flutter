...
class GradePoint extends $pb.GeneratedMessage {
  ...
  factory GradePoint.fromBuffer($core.List<$core.int> data,
      ...
      GradePoint()..mergeFromBuffer(data, registry);
  factory GradePoint.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GradePoint()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GradePoint',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: GradePoint.$_createMessage)
  ...
  @$core.Deprecated('Use GradePoint() / GradePoint.new instead')
  static GradePoint create() => GradePoint._();
  static $pb.GeneratedMessage $_createMessage() => GradePoint._();
  @$core.override
  GradePoint createEmptyInstance() => GradePoint._();
  @$core.pragma('dart2js:noInline')
  static GradePoint getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GradePoint>(GradePoint.$_createMessage);

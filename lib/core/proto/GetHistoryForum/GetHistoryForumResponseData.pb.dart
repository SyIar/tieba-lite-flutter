...
class GetHistoryForumResponseData extends $pb.GeneratedMessage {
  factory GetHistoryForumResponseData({
    ...
    final result = GetHistoryForumResponseData._();
  ...
  @$core.Deprecated(
      'Use GetHistoryForumResponseData() / GetHistoryForumResponseData.new instead')
  static GetHistoryForumResponseData create() =>
      GetHistoryForumResponseData._();
  static $pb.GeneratedMessage $_createMessage() =>
      GetHistoryForumResponseData._();
  @$core.override
  GetHistoryForumResponseData createEmptyInstance() =>
      GetHistoryForumResponseData._();
  @$core.pragma('dart2js:noInline')
  static GetHistoryForumResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetHistoryForumResponseData>(
          GetHistoryForumResponseData.$_createMessage);

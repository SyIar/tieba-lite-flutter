...
class ThemeColorInfo extends $pb.GeneratedMessage {
  ...
  factory ThemeColorInfo.fromBuffer($core.List<$core.int> data,
      ...
      ThemeColorInfo()..mergeFromBuffer(data, registry);
  factory ThemeColorInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThemeColorInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThemeColorInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ThemeColorInfo.$_createMessage)
    ..aOM<$0.ThemeElement>(1, _omitFieldNames ? '' : 'day',
        subBuilder: $0.ThemeElement.$_createMessage)
  ...
  @$core.Deprecated('Use ThemeColorInfo() / ThemeColorInfo.new instead')
  static ThemeColorInfo create() => ThemeColorInfo._();
  static $pb.GeneratedMessage $_createMessage() => ThemeColorInfo._();
  @$core.override
  ThemeColorInfo createEmptyInstance() => ThemeColorInfo._();
  @$core.pragma('dart2js:noInline')
  static ThemeColorInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThemeColorInfo>(
          ThemeColorInfo.$_createMessage);

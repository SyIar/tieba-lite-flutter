...
class PbHotPost extends $pb.GeneratedMessage {
  ...
  factory PbHotPost.fromBuffer($core.List<$core.int> data,
      ...
      PbHotPost()..mergeFromBuffer(data, registry);
  factory PbHotPost.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PbHotPost()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PbHotPost',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PbHotPost.$_createMessage)
    ...
    ..pPM<$1.HotPost>(4, _omitFieldNames ? '' : 'hotPostList',
        subBuilder: $1.HotPost.$_createMessage)
  ...
  @$core.Deprecated('Use PbHotPost() / PbHotPost.new instead')
  static PbHotPost create() => PbHotPost._();
  static $pb.GeneratedMessage $_createMessage() => PbHotPost._();
  @$core.override
  PbHotPost createEmptyInstance() => PbHotPost._();
  @$core.pragma('dart2js:noInline')
  static PbHotPost getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbHotPost>(PbHotPost.$_createMessage);

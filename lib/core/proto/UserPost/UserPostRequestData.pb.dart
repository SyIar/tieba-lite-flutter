...
class UserPostRequestData extends $pb.GeneratedMessage {
  factory UserPostRequestData({
    ...
    final result = UserPostRequestData._();
  ...
  @$core
      .Deprecated('Use UserPostRequestData() / UserPostRequestData.new instead')
  static UserPostRequestData create() => UserPostRequestData._();
  static $pb.GeneratedMessage $_createMessage() => UserPostRequestData._();
  @$core.override
  UserPostRequestData createEmptyInstance() => UserPostRequestData._();
  @$core.pragma('dart2js:noInline')
  static UserPostRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserPostRequestData>(
          UserPostRequestData.$_createMessage);

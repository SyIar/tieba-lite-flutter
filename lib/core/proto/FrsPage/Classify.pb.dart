...
class Classify extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use Classify() / Classify.new instead')
  static Classify create() => Classify._();
  static $pb.GeneratedMessage $_createMessage() => Classify._();
  @$core.override
  Classify createEmptyInstance() => Classify._();
  @$core.pragma('dart2js:noInline')
  static Classify getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Classify>(Classify.$_createMessage);

...
class PbPageRequestData extends $pb.GeneratedMessage {
  factory PbPageRequestData({
    ...
    final result = PbPageRequestData._();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.AppTransmitData>(77, _omitFieldNames ? '' : 'appTransmitData',
        subBuilder: $3.AppTransmitData.$_createMessage)
  ...
  @$core.Deprecated('Use PbPageRequestData() / PbPageRequestData.new instead')
  static PbPageRequestData create() => PbPageRequestData._();
  static $pb.GeneratedMessage $_createMessage() => PbPageRequestData._();
  @$core.override
  PbPageRequestData createEmptyInstance() => PbPageRequestData._();
  @$core.pragma('dart2js:noInline')
  static PbPageRequestData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbPageRequestData>(
          PbPageRequestData.$_createMessage);

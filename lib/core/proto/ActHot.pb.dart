...
class ActHot extends $pb.GeneratedMessage {
  ...
  factory ActHot.fromBuffer($core.List<$core.int> data,
      ...
      ActHot()..mergeFromBuffer(data, registry);
  factory ActHot.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ActHot()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ActHot',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ActHot.$_createMessage)
  ...
  @$core.Deprecated('Use ActHot() / ActHot.new instead')
  static ActHot create() => ActHot._();
  static $pb.GeneratedMessage $_createMessage() => ActHot._();
  @$core.override
  ActHot createEmptyInstance() => ActHot._();
  @$core.pragma('dart2js:noInline')
  static ActHot getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ActHot>(ActHot.$_createMessage);

...
class PollOption extends $pb.GeneratedMessage {
  ...
  factory PollOption.fromBuffer($core.List<$core.int> data,
      ...
      PollOption()..mergeFromBuffer(data, registry);
  factory PollOption.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PollOption()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PollOption',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PollOption.$_createMessage)
  ...
  @$core.Deprecated('Use PollOption() / PollOption.new instead')
  static PollOption create() => PollOption._();
  static $pb.GeneratedMessage $_createMessage() => PollOption._();
  @$core.override
  PollOption createEmptyInstance() => PollOption._();
  @$core.pragma('dart2js:noInline')
  static PollOption getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PollOption>(PollOption.$_createMessage);

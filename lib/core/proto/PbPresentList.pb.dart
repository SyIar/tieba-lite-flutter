...
class PbPresentList extends $pb.GeneratedMessage {
  ...
  factory PbPresentList.fromBuffer($core.List<$core.int> data,
      ...
      PbPresentList()..mergeFromBuffer(data, registry);
  factory PbPresentList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PbPresentList()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PbPresentList',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PbPresentList.$_createMessage)
  ...
  @$core.Deprecated('Use PbPresentList() / PbPresentList.new instead')
  static PbPresentList create() => PbPresentList._();
  static $pb.GeneratedMessage $_createMessage() => PbPresentList._();
  @$core.override
  PbPresentList createEmptyInstance() => PbPresentList._();
  @$core.pragma('dart2js:noInline')
  static PbPresentList getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbPresentList>(
          PbPresentList.$_createMessage);

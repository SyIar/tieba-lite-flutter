...
class PostBanner extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use PostBanner() / PostBanner.new instead')
  static PostBanner create() => PostBanner._();
  static $pb.GeneratedMessage $_createMessage() => PostBanner._();
  @$core.override
  PostBanner createEmptyInstance() => PostBanner._();
  @$core.pragma('dart2js:noInline')
  static PostBanner getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PostBanner>(PostBanner.$_createMessage);

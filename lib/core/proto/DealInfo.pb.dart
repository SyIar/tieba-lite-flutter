...
class DealInfo extends $pb.GeneratedMessage {
  ...
  factory DealInfo.fromBuffer($core.List<$core.int> data,
      ...
      DealInfo()..mergeFromBuffer(data, registry);
  factory DealInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      DealInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DealInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: DealInfo.$_createMessage)
    ...
    ..pPM<$1.DealAuthInfo>(13, _omitFieldNames ? '' : 'authInfo',
        subBuilder: $1.DealAuthInfo.$_createMessage)
    ..a<$fixnum.Int64>(
  ...
  @$core.Deprecated('Use DealInfo() / DealInfo.new instead')
  static DealInfo create() => DealInfo._();
  static $pb.GeneratedMessage $_createMessage() => DealInfo._();
  @$core.override
  DealInfo createEmptyInstance() => DealInfo._();
  @$core.pragma('dart2js:noInline')
  static DealInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DealInfo>(DealInfo.$_createMessage);

...
class DynamicInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use DynamicInfo() / DynamicInfo.new instead')
  static DynamicInfo create() => DynamicInfo._();
  static $pb.GeneratedMessage $_createMessage() => DynamicInfo._();
  @$core.override
  DynamicInfo createEmptyInstance() => DynamicInfo._();
  @$core.pragma('dart2js:noInline')
  static DynamicInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DynamicInfo>(
          DynamicInfo.$_createMessage);

...
class NavTabInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use NavTabInfo() / NavTabInfo.new instead')
  static NavTabInfo create() => NavTabInfo._();
  static $pb.GeneratedMessage $_createMessage() => NavTabInfo._();
  @$core.override
  NavTabInfo createEmptyInstance() => NavTabInfo._();
  @$core.pragma('dart2js:noInline')
  static NavTabInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NavTabInfo>(NavTabInfo.$_createMessage);

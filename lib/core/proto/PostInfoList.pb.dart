...
class PostInfoList extends $pb.GeneratedMessage {
  ...
  factory PostInfoList.fromBuffer($core.List<$core.int> data,
      ...
      PostInfoList()..mergeFromBuffer(data, registry);
  factory PostInfoList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PostInfoList()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PostInfoList',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PostInfoList.$_createMessage)
    ...
    ..pPM<$0.PostInfoContent>(8, _omitFieldNames ? '' : 'content',
        subBuilder: $0.PostInfoContent.$_createMessage)
    ...
    ..pPM<$1.Abstract>(15, _omitFieldNames ? '' : 'abstractThread',
        subBuilder: $1.Abstract.$_createMessage)
    ...
    ..aOM<$3.LbsInfo>(21, _omitFieldNames ? '' : 'lbsInfo',
        subBuilder: $3.LbsInfo.$_createMessage)
    ..aOM<$4.Quote>(22, _omitFieldNames ? '' : 'quote',
        subBuilder: $4.Quote.$_createMessage)
    ..pPM<$5.Voice>(23, _omitFieldNames ? '' : 'voiceInfo',
        subBuilder: $5.Voice.$_createMessage)
    ..aOM<$6.AnchorInfo>(24, _omitFieldNames ? '' : 'anchorInfo',
        subBuilder: $6.AnchorInfo.$_createMessage)
    ...
    ..aOM<$12.AlaLiveInfo>(36, _omitFieldNames ? '' : 'alaInfo',
        subBuilder: $12.AlaLiveInfo.$_createMessage)
    ...
    ..aOM<$21.UserPostPerm>(63, _omitFieldNames ? '' : 'userPostPerm',
        subBuilder: $21.UserPostPerm.$_createMessage)
  ...
  @$core.Deprecated('Use PostInfoList() / PostInfoList.new instead')
  static PostInfoList create() => PostInfoList._();
  static $pb.GeneratedMessage $_createMessage() => PostInfoList._();
  @$core.override
  PostInfoList createEmptyInstance() => PostInfoList._();
  @$core.pragma('dart2js:noInline')
  static PostInfoList getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PostInfoList>(
          PostInfoList.$_createMessage);

...
class GodDetailInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use GodDetailInfo() / GodDetailInfo.new instead')
  static GodDetailInfo create() => GodDetailInfo._();
  static $pb.GeneratedMessage $_createMessage() => GodDetailInfo._();
  @$core.override
  GodDetailInfo createEmptyInstance() => GodDetailInfo._();
  @$core.pragma('dart2js:noInline')
  static GodDetailInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GodDetailInfo>(
          GodDetailInfo.$_createMessage);

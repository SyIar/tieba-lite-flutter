...
class ForumRuleDetailResponseData extends $pb.GeneratedMessage {
  factory ForumRuleDetailResponseData({
    ...
    final result = ForumRuleDetailResponseData._();
  ...
  factory ForumRuleDetailResponseData.fromBuffer($core.List<$core.int> data,
      ...
      ForumRuleDetailResponseData()..mergeFromBuffer(data, registry);
  factory ForumRuleDetailResponseData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumRuleDetailResponseData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumRuleDetailResponseData',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.forumRuleDetail'),
      createEmptyInstance: ForumRuleDetailResponseData.$_createMessage)
    ...
    ..pPM<$1.ForumRule>(5, _omitFieldNames ? '' : 'rules',
        subBuilder: $1.ForumRule.$_createMessage)
    ...
    ..aOM<$2.BawuRoleInfoPub>(11, _omitFieldNames ? '' : 'bazhu',
        subBuilder: $2.BawuRoleInfoPub.$_createMessage)
  ...
  @$core.Deprecated(
      'Use ForumRuleDetailResponseData() / ForumRuleDetailResponseData.new instead')
  static ForumRuleDetailResponseData create() =>
      ForumRuleDetailResponseData._();
  static $pb.GeneratedMessage $_createMessage() =>
      ForumRuleDetailResponseData._();
  @$core.override
  ForumRuleDetailResponseData createEmptyInstance() =>
      ForumRuleDetailResponseData._();
  @$core.pragma('dart2js:noInline')
  static ForumRuleDetailResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForumRuleDetailResponseData>(
          ForumRuleDetailResponseData.$_createMessage);

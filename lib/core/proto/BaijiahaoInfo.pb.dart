...
class BaijiahaoInfo extends $pb.GeneratedMessage {
  ...
  factory BaijiahaoInfo.fromBuffer($core.List<$core.int> data,
      ...
      BaijiahaoInfo()..mergeFromBuffer(data, registry);
  factory BaijiahaoInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BaijiahaoInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BaijiahaoInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BaijiahaoInfo.$_createMessage)
  ...
  @$core.Deprecated('Use BaijiahaoInfo() / BaijiahaoInfo.new instead')
  static BaijiahaoInfo create() => BaijiahaoInfo._();
  static $pb.GeneratedMessage $_createMessage() => BaijiahaoInfo._();
  @$core.override
  BaijiahaoInfo createEmptyInstance() => BaijiahaoInfo._();
  @$core.pragma('dart2js:noInline')
  static BaijiahaoInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BaijiahaoInfo>(
          BaijiahaoInfo.$_createMessage);

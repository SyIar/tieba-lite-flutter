...
class PbPostZan extends $pb.GeneratedMessage {
  ...
  factory PbPostZan.fromBuffer($core.List<$core.int> data,
      ...
      PbPostZan()..mergeFromBuffer(data, registry);
  factory PbPostZan.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PbPostZan()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PbPostZan',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PbPostZan.$_createMessage)
  ...
  @$core.Deprecated('Use PbPostZan() / PbPostZan.new instead')
  static PbPostZan create() => PbPostZan._();
  static $pb.GeneratedMessage $_createMessage() => PbPostZan._();
  @$core.override
  PbPostZan createEmptyInstance() => PbPostZan._();
  @$core.pragma('dart2js:noInline')
  static PbPostZan getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbPostZan>(PbPostZan.$_createMessage);

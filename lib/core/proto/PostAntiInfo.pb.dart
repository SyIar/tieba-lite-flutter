...
class PostAntiInfo extends $pb.GeneratedMessage {
  ...
  factory PostAntiInfo.fromBuffer($core.List<$core.int> data,
      ...
      PostAntiInfo()..mergeFromBuffer(data, registry);
  factory PostAntiInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PostAntiInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PostAntiInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PostAntiInfo.$_createMessage)
    ..aOM<$0.AccessState>(1, _omitFieldNames ? '' : 'accessState',
        subBuilder: $0.AccessState.$_createMessage)
    ...
    ..aOM<$1.VcodeExtra>(13, _omitFieldNames ? '' : 'vcodeExtra',
        subBuilder: $1.VcodeExtra.$_createMessage)
  ...
  @$core.Deprecated('Use PostAntiInfo() / PostAntiInfo.new instead')
  static PostAntiInfo create() => PostAntiInfo._();
  static $pb.GeneratedMessage $_createMessage() => PostAntiInfo._();
  @$core.override
  PostAntiInfo createEmptyInstance() => PostAntiInfo._();
  @$core.pragma('dart2js:noInline')
  static PostAntiInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PostAntiInfo>(
          PostAntiInfo.$_createMessage);

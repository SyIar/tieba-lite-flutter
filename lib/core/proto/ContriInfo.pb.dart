...
class ContriInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use ContriInfo() / ContriInfo.new instead')
  static ContriInfo create() => ContriInfo._();
  static $pb.GeneratedMessage $_createMessage() => ContriInfo._();
  @$core.override
  ContriInfo createEmptyInstance() => ContriInfo._();
  @$core.pragma('dart2js:noInline')
  static ContriInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContriInfo>(ContriInfo.$_createMessage);

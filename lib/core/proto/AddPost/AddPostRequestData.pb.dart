...
class AddPostRequestData extends $pb.GeneratedMessage {
  factory AddPostRequestData({
    ...
    final result = AddPostRequestData._();
  ...
  @$core.Deprecated('Use AddPostRequestData() / AddPostRequestData.new instead')
  static AddPostRequestData create() => AddPostRequestData._();
  static $pb.GeneratedMessage $_createMessage() => AddPostRequestData._();
  @$core.override
  AddPostRequestData createEmptyInstance() => AddPostRequestData._();
  @$core.pragma('dart2js:noInline')
  static AddPostRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AddPostRequestData>(
          AddPostRequestData.$_createMessage);

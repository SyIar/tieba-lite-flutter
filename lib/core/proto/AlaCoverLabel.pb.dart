...
class AlaCoverLabel extends $pb.GeneratedMessage {
  ...
  factory AlaCoverLabel.fromBuffer($core.List<$core.int> data,
      ...
      AlaCoverLabel()..mergeFromBuffer(data, registry);
  factory AlaCoverLabel.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AlaCoverLabel()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AlaCoverLabel',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AlaCoverLabel.$_createMessage)
  ...
  @$core.Deprecated('Use AlaCoverLabel() / AlaCoverLabel.new instead')
  static AlaCoverLabel create() => AlaCoverLabel._();
  static $pb.GeneratedMessage $_createMessage() => AlaCoverLabel._();
  @$core.override
  AlaCoverLabel createEmptyInstance() => AlaCoverLabel._();
  @$core.pragma('dart2js:noInline')
  static AlaCoverLabel getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AlaCoverLabel>(
          AlaCoverLabel.$_createMessage);

...
class GetMemberInfoRequest extends $pb.GeneratedMessage {
  factory GetMemberInfoRequest({
    ...
    final result = GetMemberInfoRequest._();
  ...
  @$core.Deprecated(
      'Use GetMemberInfoRequest() / GetMemberInfoRequest.new instead')
  static GetMemberInfoRequest create() => GetMemberInfoRequest._();
  static $pb.GeneratedMessage $_createMessage() => GetMemberInfoRequest._();
  @$core.override
  GetMemberInfoRequest createEmptyInstance() => GetMemberInfoRequest._();
  @$core.pragma('dart2js:noInline')
  static GetMemberInfoRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetMemberInfoRequest>(
          GetMemberInfoRequest.$_createMessage);

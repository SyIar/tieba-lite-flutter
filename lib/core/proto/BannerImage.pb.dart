...
class BannerImage extends $pb.GeneratedMessage {
  ...
  factory BannerImage.fromBuffer($core.List<$core.int> data,
      ...
      BannerImage()..mergeFromBuffer(data, registry);
  factory BannerImage.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BannerImage()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BannerImage',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BannerImage.$_createMessage)
  ...
  @$core.Deprecated('Use BannerImage() / BannerImage.new instead')
  static BannerImage create() => BannerImage._();
  static $pb.GeneratedMessage $_createMessage() => BannerImage._();
  @$core.override
  BannerImage createEmptyInstance() => BannerImage._();
  @$core.pragma('dart2js:noInline')
  static BannerImage getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BannerImage>(
          BannerImage.$_createMessage);

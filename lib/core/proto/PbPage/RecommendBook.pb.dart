...
class RecommendBook extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use RecommendBook() / RecommendBook.new instead')
  static RecommendBook create() => RecommendBook._();
  static $pb.GeneratedMessage $_createMessage() => RecommendBook._();
  @$core.override
  RecommendBook createEmptyInstance() => RecommendBook._();
  @$core.pragma('dart2js:noInline')
  static RecommendBook getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecommendBook>(
          RecommendBook.$_createMessage);

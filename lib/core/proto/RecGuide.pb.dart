...
class RecGuide extends $pb.GeneratedMessage {
  ...
  factory RecGuide.fromBuffer($core.List<$core.int> data,
      ...
      RecGuide()..mergeFromBuffer(data, registry);
  factory RecGuide.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      RecGuide()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RecGuide',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: RecGuide.$_createMessage)
  ...
  @$core.Deprecated('Use RecGuide() / RecGuide.new instead')
  static RecGuide create() => RecGuide._();
  static $pb.GeneratedMessage $_createMessage() => RecGuide._();
  @$core.override
  RecGuide createEmptyInstance() => RecGuide._();
  @$core.pragma('dart2js:noInline')
  static RecGuide getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RecGuide>(RecGuide.$_createMessage);

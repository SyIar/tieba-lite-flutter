...
class SearchSugResponseData extends $pb.GeneratedMessage {
  factory SearchSugResponseData({
    ...
    final result = SearchSugResponseData._();
  ...
  @$core.Deprecated(
      'Use SearchSugResponseData() / SearchSugResponseData.new instead')
  static SearchSugResponseData create() => SearchSugResponseData._();
  static $pb.GeneratedMessage $_createMessage() => SearchSugResponseData._();
  @$core.override
  SearchSugResponseData createEmptyInstance() => SearchSugResponseData._();
  @$core.pragma('dart2js:noInline')
  static SearchSugResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SearchSugResponseData>(
          SearchSugResponseData.$_createMessage);

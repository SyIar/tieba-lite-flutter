...
class ThreadPicList extends $pb.GeneratedMessage {
  ...
  factory ThreadPicList.fromBuffer($core.List<$core.int> data,
      ...
      ThreadPicList()..mergeFromBuffer(data, registry);
  factory ThreadPicList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadPicList()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThreadPicList',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ThreadPicList.$_createMessage)
  ...
  @$core.Deprecated('Use ThreadPicList() / ThreadPicList.new instead')
  static ThreadPicList create() => ThreadPicList._();
  static $pb.GeneratedMessage $_createMessage() => ThreadPicList._();
  @$core.override
  ThreadPicList createEmptyInstance() => ThreadPicList._();
  @$core.pragma('dart2js:noInline')
  static ThreadPicList getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThreadPicList>(
          ThreadPicList.$_createMessage);

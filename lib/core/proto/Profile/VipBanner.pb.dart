...
class VipBanner extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use VipBanner() / VipBanner.new instead')
  static VipBanner create() => VipBanner._();
  static $pb.GeneratedMessage $_createMessage() => VipBanner._();
  @$core.override
  VipBanner createEmptyInstance() => VipBanner._();
  @$core.pragma('dart2js:noInline')
  static VipBanner getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VipBanner>(VipBanner.$_createMessage);

...
class UserPics extends $pb.GeneratedMessage {
  ...
  factory UserPics.fromBuffer($core.List<$core.int> data,
      ...
      UserPics()..mergeFromBuffer(data, registry);
  factory UserPics.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserPics()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserPics',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: UserPics.$_createMessage)
  ...
  @$core.Deprecated('Use UserPics() / UserPics.new instead')
  static UserPics create() => UserPics._();
  static $pb.GeneratedMessage $_createMessage() => UserPics._();
  @$core.override
  UserPics createEmptyInstance() => UserPics._();
  @$core.pragma('dart2js:noInline')
  static UserPics getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserPics>(UserPics.$_createMessage);

...
class AlaUserInfo extends $pb.GeneratedMessage {
  ...
  factory AlaUserInfo.fromBuffer($core.List<$core.int> data,
      ...
      AlaUserInfo()..mergeFromBuffer(data, registry);
  factory AlaUserInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AlaUserInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AlaUserInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AlaUserInfo.$_createMessage)
    ...
    ..aOM<$0.YyExt>(25, _omitFieldNames ? '' : 'yyExt',
        subBuilder: $0.YyExt.$_createMessage)
  ...
  @$core.Deprecated('Use AlaUserInfo() / AlaUserInfo.new instead')
  static AlaUserInfo create() => AlaUserInfo._();
  static $pb.GeneratedMessage $_createMessage() => AlaUserInfo._();
  @$core.override
  AlaUserInfo createEmptyInstance() => AlaUserInfo._();
  @$core.pragma('dart2js:noInline')
  static AlaUserInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AlaUserInfo>(
          AlaUserInfo.$_createMessage);

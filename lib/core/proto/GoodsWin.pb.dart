...
class GoodsWin extends $pb.GeneratedMessage {
  ...
  factory GoodsWin.fromBuffer($core.List<$core.int> data,
      ...
      GoodsWin()..mergeFromBuffer(data, registry);
  factory GoodsWin.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GoodsWin()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GoodsWin',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: GoodsWin.$_createMessage)
  ...
  @$core.Deprecated('Use GoodsWin() / GoodsWin.new instead')
  static GoodsWin create() => GoodsWin._();
  static $pb.GeneratedMessage $_createMessage() => GoodsWin._();
  @$core.override
  GoodsWin createEmptyInstance() => GoodsWin._();
  @$core.pragma('dart2js:noInline')
  static GoodsWin getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GoodsWin>(GoodsWin.$_createMessage);

...
class Abstract extends $pb.GeneratedMessage {
  ...
  factory Abstract.fromBuffer($core.List<$core.int> data,
      ...
      Abstract()..mergeFromBuffer(data, registry);
  factory Abstract.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Abstract()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Abstract',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Abstract.$_createMessage)
  ...
  @$core.Deprecated('Use Abstract() / Abstract.new instead')
  static Abstract create() => Abstract._();
  static $pb.GeneratedMessage $_createMessage() => Abstract._();
  @$core.override
  Abstract createEmptyInstance() => Abstract._();
  @$core.pragma('dart2js:noInline')
  static Abstract getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Abstract>(Abstract.$_createMessage);

...
class ServiceArea extends $pb.GeneratedMessage {
  ...
  factory ServiceArea.fromBuffer($core.List<$core.int> data,
      ...
      ServiceArea()..mergeFromBuffer(data, registry);
  factory ServiceArea.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ServiceArea()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ServiceArea',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ServiceArea.$_createMessage)
    ...
    ..aOM<$0.SmartApp>(6, _omitFieldNames ? '' : 'areaSmartApp',
        subBuilder: $0.SmartApp.$_createMessage)
  ...
  @$core.Deprecated('Use ServiceArea() / ServiceArea.new instead')
  static ServiceArea create() => ServiceArea._();
  static $pb.GeneratedMessage $_createMessage() => ServiceArea._();
  @$core.override
  ServiceArea createEmptyInstance() => ServiceArea._();
  @$core.pragma('dart2js:noInline')
  static ServiceArea getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ServiceArea>(
          ServiceArea.$_createMessage);

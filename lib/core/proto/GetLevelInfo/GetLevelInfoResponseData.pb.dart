...
class GetLevelInfoResponseData extends $pb.GeneratedMessage {
  factory GetLevelInfoResponseData({
    ...
    final result = GetLevelInfoResponseData._();
  ...
  @$core.Deprecated(
      'Use GetLevelInfoResponseData() / GetLevelInfoResponseData.new instead')
  static GetLevelInfoResponseData create() => GetLevelInfoResponseData._();
  static $pb.GeneratedMessage $_createMessage() => GetLevelInfoResponseData._();
  @$core.override
  GetLevelInfoResponseData createEmptyInstance() =>
      GetLevelInfoResponseData._();
  @$core.pragma('dart2js:noInline')
  static GetLevelInfoResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetLevelInfoResponseData>(
          GetLevelInfoResponseData.$_createMessage);

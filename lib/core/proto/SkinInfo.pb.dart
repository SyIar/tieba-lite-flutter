...
class SkinInfo extends $pb.GeneratedMessage {
  ...
  factory SkinInfo.fromBuffer($core.List<$core.int> data,
      ...
      SkinInfo()..mergeFromBuffer(data, registry);
  factory SkinInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      SkinInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SkinInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: SkinInfo.$_createMessage)
  ...
  @$core.Deprecated('Use SkinInfo() / SkinInfo.new instead')
  static SkinInfo create() => SkinInfo._();
  static $pb.GeneratedMessage $_createMessage() => SkinInfo._();
  @$core.override
  SkinInfo createEmptyInstance() => SkinInfo._();
  @$core.pragma('dart2js:noInline')
  static SkinInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SkinInfo>(SkinInfo.$_createMessage);

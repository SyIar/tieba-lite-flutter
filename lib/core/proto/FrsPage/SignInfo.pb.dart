...
class SignInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use SignInfo() / SignInfo.new instead')
  static SignInfo create() => SignInfo._();
  static $pb.GeneratedMessage $_createMessage() => SignInfo._();
  @$core.override
  SignInfo createEmptyInstance() => SignInfo._();
  @$core.pragma('dart2js:noInline')
  static SignInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SignInfo>(SignInfo.$_createMessage);

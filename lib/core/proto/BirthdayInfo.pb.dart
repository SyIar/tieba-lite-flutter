...
class BirthdayInfo extends $pb.GeneratedMessage {
  ...
  factory BirthdayInfo.fromBuffer($core.List<$core.int> data,
      ...
      BirthdayInfo()..mergeFromBuffer(data, registry);
  factory BirthdayInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BirthdayInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BirthdayInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BirthdayInfo.$_createMessage)
  ...
  @$core.Deprecated('Use BirthdayInfo() / BirthdayInfo.new instead')
  static BirthdayInfo create() => BirthdayInfo._();
  static $pb.GeneratedMessage $_createMessage() => BirthdayInfo._();
  @$core.override
  BirthdayInfo createEmptyInstance() => BirthdayInfo._();
  @$core.pragma('dart2js:noInline')
  static BirthdayInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BirthdayInfo>(
          BirthdayInfo.$_createMessage);

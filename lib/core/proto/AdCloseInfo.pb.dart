...
class AdCloseInfo extends $pb.GeneratedMessage {
  ...
  factory AdCloseInfo.fromBuffer($core.List<$core.int> data,
      ...
      AdCloseInfo()..mergeFromBuffer(data, registry);
  factory AdCloseInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AdCloseInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdCloseInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AdCloseInfo.$_createMessage)
    ...
    ..aOM<$0.ActionControl>(5, _omitFieldNames ? '' : 'actionControl',
        subBuilder: $0.ActionControl.$_createMessage)
  ...
  @$core.Deprecated('Use AdCloseInfo() / AdCloseInfo.new instead')
  static AdCloseInfo create() => AdCloseInfo._();
  static $pb.GeneratedMessage $_createMessage() => AdCloseInfo._();
  @$core.override
  AdCloseInfo createEmptyInstance() => AdCloseInfo._();
  @$core.pragma('dart2js:noInline')
  static AdCloseInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AdCloseInfo>(
          AdCloseInfo.$_createMessage);

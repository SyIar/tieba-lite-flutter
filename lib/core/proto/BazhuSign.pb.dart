...
class BazhuSign extends $pb.GeneratedMessage {
  ...
  factory BazhuSign.fromBuffer($core.List<$core.int> data,
      ...
      BazhuSign()..mergeFromBuffer(data, registry);
  factory BazhuSign.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BazhuSign()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BazhuSign',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BazhuSign.$_createMessage)
  ...
  @$core.Deprecated('Use BazhuSign() / BazhuSign.new instead')
  static BazhuSign create() => BazhuSign._();
  static $pb.GeneratedMessage $_createMessage() => BazhuSign._();
  @$core.override
  BazhuSign createEmptyInstance() => BazhuSign._();
  @$core.pragma('dart2js:noInline')
  static BazhuSign getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BazhuSign>(BazhuSign.$_createMessage);

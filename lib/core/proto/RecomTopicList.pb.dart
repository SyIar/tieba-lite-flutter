...
class RecomTopicList extends $pb.GeneratedMessage {
  ...
  factory RecomTopicList.fromBuffer($core.List<$core.int> data,
      ...
      RecomTopicList()..mergeFromBuffer(data, registry);
  factory RecomTopicList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      RecomTopicList()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RecomTopicList',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: RecomTopicList.$_createMessage)
  ...
  @$core.Deprecated('Use RecomTopicList() / RecomTopicList.new instead')
  static RecomTopicList create() => RecomTopicList._();
  static $pb.GeneratedMessage $_createMessage() => RecomTopicList._();
  @$core.override
  RecomTopicList createEmptyInstance() => RecomTopicList._();
  @$core.pragma('dart2js:noInline')
  static RecomTopicList getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecomTopicList>(
          RecomTopicList.$_createMessage);

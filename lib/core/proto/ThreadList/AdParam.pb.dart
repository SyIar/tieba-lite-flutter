...
class AdParam extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use AdParam() / AdParam.new instead')
  static AdParam create() => AdParam._();
  static $pb.GeneratedMessage $_createMessage() => AdParam._();
  @$core.override
  AdParam createEmptyInstance() => AdParam._();
  @$core.pragma('dart2js:noInline')
  static AdParam getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdParam>(AdParam.$_createMessage);

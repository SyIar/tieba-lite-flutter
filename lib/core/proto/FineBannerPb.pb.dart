...
class FineBannerPb extends $pb.GeneratedMessage {
  ...
  factory FineBannerPb.fromBuffer($core.List<$core.int> data,
      ...
      FineBannerPb()..mergeFromBuffer(data, registry);
  factory FineBannerPb.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FineBannerPb()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FineBannerPb',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: FineBannerPb.$_createMessage)
  ...
  @$core.Deprecated('Use FineBannerPb() / FineBannerPb.new instead')
  static FineBannerPb create() => FineBannerPb._();
  static $pb.GeneratedMessage $_createMessage() => FineBannerPb._();
  @$core.override
  FineBannerPb createEmptyInstance() => FineBannerPb._();
  @$core.pragma('dart2js:noInline')
  static FineBannerPb getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FineBannerPb>(
          FineBannerPb.$_createMessage);

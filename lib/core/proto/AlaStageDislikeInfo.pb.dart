...
class AlaStageDislikeInfo extends $pb.GeneratedMessage {
  factory AlaStageDislikeInfo({
    ...
    final result = AlaStageDislikeInfo._();
  ...
  factory AlaStageDislikeInfo.fromBuffer($core.List<$core.int> data,
      ...
      AlaStageDislikeInfo()..mergeFromBuffer(data, registry);
  factory AlaStageDislikeInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AlaStageDislikeInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AlaStageDislikeInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AlaStageDislikeInfo.$_createMessage)
  ...
  @$core
      .Deprecated('Use AlaStageDislikeInfo() / AlaStageDislikeInfo.new instead')
  static AlaStageDislikeInfo create() => AlaStageDislikeInfo._();
  static $pb.GeneratedMessage $_createMessage() => AlaStageDislikeInfo._();
  @$core.override
  AlaStageDislikeInfo createEmptyInstance() => AlaStageDislikeInfo._();
  @$core.pragma('dart2js:noInline')
  static AlaStageDislikeInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AlaStageDislikeInfo>(
          AlaStageDislikeInfo.$_createMessage);

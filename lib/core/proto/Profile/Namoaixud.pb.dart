...
class Namoaixud extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use Namoaixud() / Namoaixud.new instead')
  static Namoaixud create() => Namoaixud._();
  static $pb.GeneratedMessage $_createMessage() => Namoaixud._();
  @$core.override
  Namoaixud createEmptyInstance() => Namoaixud._();
  @$core.pragma('dart2js:noInline')
  static Namoaixud getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Namoaixud>(Namoaixud.$_createMessage);

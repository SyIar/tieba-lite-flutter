...
class YyExt extends $pb.GeneratedMessage {
  ...
  factory YyExt.fromBuffer($core.List<$core.int> data,
      ...
      YyExt()..mergeFromBuffer(data, registry);
  factory YyExt.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      YyExt()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'YyExt',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: YyExt.$_createMessage)
  ...
  @$core.Deprecated('Use YyExt() / YyExt.new instead')
  static YyExt create() => YyExt._();
  static $pb.GeneratedMessage $_createMessage() => YyExt._();
  @$core.override
  YyExt createEmptyInstance() => YyExt._();
  @$core.pragma('dart2js:noInline')
  static YyExt getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<YyExt>(YyExt.$_createMessage);

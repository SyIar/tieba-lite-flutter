...
class SimpleUser extends $pb.GeneratedMessage {
  ...
  factory SimpleUser.fromBuffer($core.List<$core.int> data,
      ...
      SimpleUser()..mergeFromBuffer(data, registry);
  factory SimpleUser.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      SimpleUser()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SimpleUser',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: SimpleUser.$_createMessage)
  ...
  @$core.Deprecated('Use SimpleUser() / SimpleUser.new instead')
  static SimpleUser create() => SimpleUser._();
  static $pb.GeneratedMessage $_createMessage() => SimpleUser._();
  @$core.override
  SimpleUser createEmptyInstance() => SimpleUser._();
  @$core.pragma('dart2js:noInline')
  static SimpleUser getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SimpleUser>(SimpleUser.$_createMessage);

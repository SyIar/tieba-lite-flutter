...
class ManagerElectionTab extends $pb.GeneratedMessage {
  factory ManagerElectionTab({
    ...
    final result = ManagerElectionTab._();
  ...
  factory ManagerElectionTab.fromBuffer($core.List<$core.int> data,
      ...
      ManagerElectionTab()..mergeFromBuffer(data, registry);
  factory ManagerElectionTab.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ManagerElectionTab()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ManagerElectionTab',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.getForumDetail'),
      createEmptyInstance: ManagerElectionTab.$_createMessage)
  ...
  @$core.Deprecated('Use ManagerElectionTab() / ManagerElectionTab.new instead')
  static ManagerElectionTab create() => ManagerElectionTab._();
  static $pb.GeneratedMessage $_createMessage() => ManagerElectionTab._();
  @$core.override
  ManagerElectionTab createEmptyInstance() => ManagerElectionTab._();
  @$core.pragma('dart2js:noInline')
  static ManagerElectionTab getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ManagerElectionTab>(
          ManagerElectionTab.$_createMessage);

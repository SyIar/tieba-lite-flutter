...
class GraffitiRankItem extends $pb.GeneratedMessage {
  factory GraffitiRankItem({
    ...
    final result = GraffitiRankItem._();
  ...
  factory GraffitiRankItem.fromBuffer($core.List<$core.int> data,
      ...
      GraffitiRankItem()..mergeFromBuffer(data, registry);
  factory GraffitiRankItem.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GraffitiRankItem()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GraffitiRankItem',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: GraffitiRankItem.$_createMessage)
  ...
  @$core.Deprecated('Use GraffitiRankItem() / GraffitiRankItem.new instead')
  static GraffitiRankItem create() => GraffitiRankItem._();
  static $pb.GeneratedMessage $_createMessage() => GraffitiRankItem._();
  @$core.override
  GraffitiRankItem createEmptyInstance() => GraffitiRankItem._();
  @$core.pragma('dart2js:noInline')
  static GraffitiRankItem getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GraffitiRankItem>(
          GraffitiRankItem.$_createMessage);

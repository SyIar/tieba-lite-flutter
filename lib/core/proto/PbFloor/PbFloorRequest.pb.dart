...
class PbFloorRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use PbFloorRequest() / PbFloorRequest.new instead')
  static PbFloorRequest create() => PbFloorRequest._();
  static $pb.GeneratedMessage $_createMessage() => PbFloorRequest._();
  @$core.override
  PbFloorRequest createEmptyInstance() => PbFloorRequest._();
  @$core.pragma('dart2js:noInline')
  static PbFloorRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbFloorRequest>(
          PbFloorRequest.$_createMessage);

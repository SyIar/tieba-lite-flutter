...
class CommonLocation extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use CommonLocation() / CommonLocation.new instead')
  static CommonLocation create() => CommonLocation._();
  static $pb.GeneratedMessage $_createMessage() => CommonLocation._();
  @$core.override
  CommonLocation createEmptyInstance() => CommonLocation._();
  @$core.pragma('dart2js:noInline')
  static CommonLocation getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CommonLocation>(
          CommonLocation.$_createMessage);

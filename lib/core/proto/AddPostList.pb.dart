...
class AddPostList extends $pb.GeneratedMessage {
  ...
  factory AddPostList.fromBuffer($core.List<$core.int> data,
      ...
      AddPostList()..mergeFromBuffer(data, registry);
  factory AddPostList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AddPostList()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AddPostList',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AddPostList.$_createMessage)
    ...
    ..pPM<$0.SubPostList>(4, _omitFieldNames ? '' : 'addPostList',
        subBuilder: $0.SubPostList.$_createMessage)
  ...
  @$core.Deprecated('Use AddPostList() / AddPostList.new instead')
  static AddPostList create() => AddPostList._();
  static $pb.GeneratedMessage $_createMessage() => AddPostList._();
  @$core.override
  AddPostList createEmptyInstance() => AddPostList._();
  @$core.pragma('dart2js:noInline')
  static AddPostList getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AddPostList>(
          AddPostList.$_createMessage);

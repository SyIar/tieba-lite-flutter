...
class ActivityHead extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use ActivityHead() / ActivityHead.new instead')
  static ActivityHead create() => ActivityHead._();
  static $pb.GeneratedMessage $_createMessage() => ActivityHead._();
  @$core.override
  ActivityHead createEmptyInstance() => ActivityHead._();
  @$core.pragma('dart2js:noInline')
  static ActivityHead getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ActivityHead>(
          ActivityHead.$_createMessage);

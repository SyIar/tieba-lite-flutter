...
class Icon extends $pb.GeneratedMessage {
  ...
  factory Icon.fromBuffer($core.List<$core.int> data,
      ...
      Icon()..mergeFromBuffer(data, registry);
  factory Icon.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Icon()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Icon',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Icon.$_createMessage)
    ...
    ..aOM<$0.Terminal>(6, _omitFieldNames ? '' : 'terminal',
        subBuilder: $0.Terminal.$_createMessage)
    ..aOM<$1.Position>(7, _omitFieldNames ? '' : 'position',
        subBuilder: $1.Position.$_createMessage)
  ...
  @$core.Deprecated('Use Icon() / Icon.new instead')
  static Icon create() => Icon._();
  static $pb.GeneratedMessage $_createMessage() => Icon._();
  @$core.override
  Icon createEmptyInstance() => Icon._();
  @$core.pragma('dart2js:noInline')
  static Icon getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Icon>(Icon.$_createMessage);

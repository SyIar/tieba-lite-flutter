...
class FloatingIconItem extends $pb.GeneratedMessage {
  factory FloatingIconItem({
    ...
    final result = FloatingIconItem._();
  ...
  @$core.Deprecated('Use FloatingIconItem() / FloatingIconItem.new instead')
  static FloatingIconItem create() => FloatingIconItem._();
  static $pb.GeneratedMessage $_createMessage() => FloatingIconItem._();
  @$core.override
  FloatingIconItem createEmptyInstance() => FloatingIconItem._();
  @$core.pragma('dart2js:noInline')
  static FloatingIconItem getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FloatingIconItem>(
          FloatingIconItem.$_createMessage);

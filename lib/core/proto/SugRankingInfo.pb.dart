...
class SugRankingInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use SugRankingInfo() / SugRankingInfo.new instead')
  static SugRankingInfo create() => SugRankingInfo._();
  static $pb.GeneratedMessage $_createMessage() => SugRankingInfo._();
  @$core.override
  SugRankingInfo createEmptyInstance() => SugRankingInfo._();
  @$core.pragma('dart2js:noInline')
  static SugRankingInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SugRankingInfo>(
          SugRankingInfo.$_createMessage);

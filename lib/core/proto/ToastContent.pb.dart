...
class ToastContent extends $pb.GeneratedMessage {
  ...
  factory ToastContent.fromBuffer($core.List<$core.int> data,
      ...
      ToastContent()..mergeFromBuffer(data, registry);
  factory ToastContent.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ToastContent()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ToastContent',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ToastContent.$_createMessage)
  ...
  @$core.Deprecated('Use ToastContent() / ToastContent.new instead')
  static ToastContent create() => ToastContent._();
  static $pb.GeneratedMessage $_createMessage() => ToastContent._();
  @$core.override
  ToastContent createEmptyInstance() => ToastContent._();
  @$core.pragma('dart2js:noInline')
  static ToastContent getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ToastContent>(
          ToastContent.$_createMessage);

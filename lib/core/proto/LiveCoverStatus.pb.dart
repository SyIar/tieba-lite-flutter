...
class LiveCoverStatus extends $pb.GeneratedMessage {
  factory LiveCoverStatus({
    ...
    final result = LiveCoverStatus._();
  ...
  factory LiveCoverStatus.fromBuffer($core.List<$core.int> data,
      ...
      LiveCoverStatus()..mergeFromBuffer(data, registry);
  factory LiveCoverStatus.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      LiveCoverStatus()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LiveCoverStatus',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: LiveCoverStatus.$_createMessage)
  ...
  @$core.Deprecated('Use LiveCoverStatus() / LiveCoverStatus.new instead')
  static LiveCoverStatus create() => LiveCoverStatus._();
  static $pb.GeneratedMessage $_createMessage() => LiveCoverStatus._();
  @$core.override
  LiveCoverStatus createEmptyInstance() => LiveCoverStatus._();
  @$core.pragma('dart2js:noInline')
  static LiveCoverStatus getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LiveCoverStatus>(
          LiveCoverStatus.$_createMessage);

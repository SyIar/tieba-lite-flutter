...
class GetUserInfoRequest extends $pb.GeneratedMessage {
  factory GetUserInfoRequest({
    ...
    final result = GetUserInfoRequest._();
  ...
  @$core.Deprecated('Use GetUserInfoRequest() / GetUserInfoRequest.new instead')
  static GetUserInfoRequest create() => GetUserInfoRequest._();
  static $pb.GeneratedMessage $_createMessage() => GetUserInfoRequest._();
  @$core.override
  GetUserInfoRequest createEmptyInstance() => GetUserInfoRequest._();
  @$core.pragma('dart2js:noInline')
  static GetUserInfoRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetUserInfoRequest>(
          GetUserInfoRequest.$_createMessage);

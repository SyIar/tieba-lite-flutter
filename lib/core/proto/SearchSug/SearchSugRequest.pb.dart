...
class SearchSugRequest extends $pb.GeneratedMessage {
  factory SearchSugRequest({
    ...
    final result = SearchSugRequest._();
  ...
  @$core.Deprecated('Use SearchSugRequest() / SearchSugRequest.new instead')
  static SearchSugRequest create() => SearchSugRequest._();
  static $pb.GeneratedMessage $_createMessage() => SearchSugRequest._();
  @$core.override
  SearchSugRequest createEmptyInstance() => SearchSugRequest._();
  @$core.pragma('dart2js:noInline')
  static SearchSugRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SearchSugRequest>(
          SearchSugRequest.$_createMessage);

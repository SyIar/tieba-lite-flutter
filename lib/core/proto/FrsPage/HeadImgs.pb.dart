...
class HeadImgs extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.CoverImageColor>(26, _omitFieldNames ? '' : 'coverImageColor',
        subBuilder: $0.CoverImageColor.$_createMessage)
    ..pPM<$1.VideoImageColor>(27, _omitFieldNames ? '' : 'videoImageColor',
        subBuilder: $1.VideoImageColor.$_createMessage)
  ...
  @$core.Deprecated('Use HeadImgs() / HeadImgs.new instead')
  static HeadImgs create() => HeadImgs._();
  static $pb.GeneratedMessage $_createMessage() => HeadImgs._();
  @$core.override
  HeadImgs createEmptyInstance() => HeadImgs._();
  @$core.pragma('dart2js:noInline')
  static HeadImgs getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<HeadImgs>(HeadImgs.$_createMessage);

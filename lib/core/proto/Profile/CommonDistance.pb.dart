...
class CommonDistance extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use CommonDistance() / CommonDistance.new instead')
  static CommonDistance create() => CommonDistance._();
  static $pb.GeneratedMessage $_createMessage() => CommonDistance._();
  @$core.override
  CommonDistance createEmptyInstance() => CommonDistance._();
  @$core.pragma('dart2js:noInline')
  static CommonDistance getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CommonDistance>(
          CommonDistance.$_createMessage);

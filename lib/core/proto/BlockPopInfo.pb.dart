...
class BlockPopInfo extends $pb.GeneratedMessage {
  ...
  factory BlockPopInfo.fromBuffer($core.List<$core.int> data,
      ...
      BlockPopInfo()..mergeFromBuffer(data, registry);
  factory BlockPopInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BlockPopInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BlockPopInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BlockPopInfo.$_createMessage)
  ...
  @$core.Deprecated('Use BlockPopInfo() / BlockPopInfo.new instead')
  static BlockPopInfo create() => BlockPopInfo._();
  static $pb.GeneratedMessage $_createMessage() => BlockPopInfo._();
  @$core.override
  BlockPopInfo createEmptyInstance() => BlockPopInfo._();
  @$core.pragma('dart2js:noInline')
  static BlockPopInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BlockPopInfo>(
          BlockPopInfo.$_createMessage);

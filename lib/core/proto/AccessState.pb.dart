...
class AccessState extends $pb.GeneratedMessage {
  ...
  factory AccessState.fromBuffer($core.List<$core.int> data,
      ...
      AccessState()..mergeFromBuffer(data, registry);
  factory AccessState.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AccessState()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AccessState',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AccessState.$_createMessage)
    ..aOS(1, _omitFieldNames ? '' : 'type')
    ..aOS(2, _omitFieldNames ? '' : 'token')
    ..aOM<$0.UserSessionInfo>(3, _omitFieldNames ? '' : 'userinfo',
        subBuilder: $0.UserSessionInfo.$_createMessage)
  ...
  @$core.Deprecated('Use AccessState() / AccessState.new instead')
  static AccessState create() => AccessState._();
  static $pb.GeneratedMessage $_createMessage() => AccessState._();
  @$core.override
  AccessState createEmptyInstance() => AccessState._();
  @$core.pragma('dart2js:noInline')
  static AccessState getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AccessState>(
          AccessState.$_createMessage);

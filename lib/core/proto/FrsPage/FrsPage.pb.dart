...
class FrsPageRequestData extends $pb.GeneratedMessage {
  factory FrsPageRequestData({
    ...
    final result = FrsPageRequestData._();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.AdParam>(51, _omitFieldNames ? '' : 'adParam',
        subBuilder: $2.AdParam.$_createMessage)
  ...
  @$core.Deprecated('Use FrsPageRequestData() / FrsPageRequestData.new instead')
  static FrsPageRequestData create() => FrsPageRequestData._();
  static $pb.GeneratedMessage $_createMessage() => FrsPageRequestData._();
  @$core.override
  FrsPageRequestData createEmptyInstance() => FrsPageRequestData._();
  @$core.pragma('dart2js:noInline')
  static FrsPageRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FrsPageRequestData>(
          FrsPageRequestData.$_createMessage);
...
class FrsPageRequest extends $pb.GeneratedMessage {
  ...
  factory FrsPageRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FrsPageRequest()..mergeFromBuffer(data, registry);
  factory FrsPageRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FrsPageRequest()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FrsPageRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba.frsPage'),
      createEmptyInstance: FrsPageRequest.$_createMessage)
    ..aOM<FrsPageRequestData>(1, _omitFieldNames ? '' : 'data',
        subBuilder: FrsPageRequestData.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use FrsPageRequest() / FrsPageRequest.new instead')
  static FrsPageRequest create() => FrsPageRequest._();
  static $pb.GeneratedMessage $_createMessage() => FrsPageRequest._();
  @$core.override
  FrsPageRequest createEmptyInstance() => FrsPageRequest._();
  @$core.pragma('dart2js:noInline')
  static FrsPageRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FrsPageRequest>(
          FrsPageRequest.$_createMessage);
...
class FrsPageResponseData extends $pb.GeneratedMessage {
  factory FrsPageResponseData({
    ...
    final result = FrsPageResponseData._();
  ...
  factory FrsPageResponseData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FrsPageResponseData()..mergeFromBuffer(data, registry);
  factory FrsPageResponseData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FrsPageResponseData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FrsPageResponseData',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba.frsPage'),
      createEmptyInstance: FrsPageResponseData.$_createMessage)
    ..aOM<$3.User>(1, _omitFieldNames ? '' : 'user',
        subBuilder: $3.User.$_createMessage)
    ..aOM<$4.ForumInfo>(2, _omitFieldNames ? '' : 'forum',
        subBuilder: $4.ForumInfo.$_createMessage)
    ..aOM<$5.Page>(4, _omitFieldNames ? '' : 'page',
        subBuilder: $5.Page.$_createMessage)
    ..aOM<$6.Anti>(5, _omitFieldNames ? '' : 'anti',
        subBuilder: $6.Anti.$_createMessage)
    ..aOM<$7.Group>(6, _omitFieldNames ? '' : 'group',
        subBuilder: $7.Group.$_createMessage)
    ..pPM<$8.ThreadInfo>(7, _omitFieldNames ? '' : 'threadList',
        subBuilder: $8.ThreadInfo.$_createMessage)
    ..p<$fixnum.Int64>(
    ...
    ..pPM<$9.FrsTabInfo>(22, _omitFieldNames ? '' : 'frsTabInfo',
        subBuilder: $9.FrsTabInfo.$_createMessage)
    ..aOM<$10.ActivityHead>(23, _omitFieldNames ? '' : 'activityHead',
        subBuilder: $10.ActivityHead.$_createMessage)
    ..aOM<$11.NavTabInfo>(37, _omitFieldNames ? '' : 'navTabInfo',
        subBuilder: $11.NavTabInfo.$_createMessage)
    ..aOM<$12.ForumRuleStatus>(105, _omitFieldNames ? '' : 'forumRule',
        subBuilder: $12.ForumRuleStatus.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core
      .Deprecated('Use FrsPageResponseData() / FrsPageResponseData.new instead')
  static FrsPageResponseData create() => FrsPageResponseData._();
  static $pb.GeneratedMessage $_createMessage() => FrsPageResponseData._();
  @$core.override
  FrsPageResponseData createEmptyInstance() => FrsPageResponseData._();
  @$core.pragma('dart2js:noInline')
  static FrsPageResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FrsPageResponseData>(
          FrsPageResponseData.$_createMessage);
...
class FrsPageResponse extends $pb.GeneratedMessage {
  factory FrsPageResponse({
    ...
    final result = FrsPageResponse._();
  ...
  factory FrsPageResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FrsPageResponse()..mergeFromBuffer(data, registry);
  factory FrsPageResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      FrsPageResponse()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FrsPageResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba.frsPage'),
      createEmptyInstance: FrsPageResponse.$_createMessage)
    ..aOM<$13.Error>(1, _omitFieldNames ? '' : 'error',
        subBuilder: $13.Error.$_createMessage)
    ..aOM<FrsPageResponseData>(2, _omitFieldNames ? '' : 'data',
        subBuilder: FrsPageResponseData.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use FrsPageResponse() / FrsPageResponse.new instead')
  static FrsPageResponse create() => FrsPageResponse._();
  static $pb.GeneratedMessage $_createMessage() => FrsPageResponse._();
  @$core.override
  FrsPageResponse createEmptyInstance() => FrsPageResponse._();
  @$core.pragma('dart2js:noInline')
  static FrsPageResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FrsPageResponse>(
          FrsPageResponse.$_createMessage);

...
class GetHistoryForumResponse extends $pb.GeneratedMessage {
  factory GetHistoryForumResponse({
    ...
    final result = GetHistoryForumResponse._();
  ...
  factory GetHistoryForumResponse.fromBuffer($core.List<$core.int> data,
      ...
      GetHistoryForumResponse()..mergeFromBuffer(data, registry);
  factory GetHistoryForumResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GetHistoryForumResponse()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetHistoryForumResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.getHistoryForum'),
      createEmptyInstance: GetHistoryForumResponse.$_createMessage)
    ...
    ..aOM<$1.GetHistoryForumResponseData>(2, _omitFieldNames ? '' : 'data',
        subBuilder: $1.GetHistoryForumResponseData.$_createMessage)
  ...
  @$core.Deprecated(
      'Use GetHistoryForumResponse() / GetHistoryForumResponse.new instead')
  static GetHistoryForumResponse create() => GetHistoryForumResponse._();
  static $pb.GeneratedMessage $_createMessage() => GetHistoryForumResponse._();
  @$core.override
  GetHistoryForumResponse createEmptyInstance() => GetHistoryForumResponse._();
  @$core.pragma('dart2js:noInline')
  static GetHistoryForumResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetHistoryForumResponse>(
          GetHistoryForumResponse.$_createMessage);

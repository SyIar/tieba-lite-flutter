...
class BusinessPromotInfo extends $pb.GeneratedMessage {
  factory BusinessPromotInfo({
    ...
    final result = BusinessPromotInfo._();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.SendCardInfo>(4, _omitFieldNames ? '' : 'sendCardInfo',
        subBuilder: $0.SendCardInfo.$_createMessage)
  ...
  @$core.Deprecated('Use BusinessPromotInfo() / BusinessPromotInfo.new instead')
  static BusinessPromotInfo create() => BusinessPromotInfo._();
  static $pb.GeneratedMessage $_createMessage() => BusinessPromotInfo._();
  @$core.override
  BusinessPromotInfo createEmptyInstance() => BusinessPromotInfo._();
  @$core.pragma('dart2js:noInline')
  static BusinessPromotInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BusinessPromotInfo>(
          BusinessPromotInfo.$_createMessage);

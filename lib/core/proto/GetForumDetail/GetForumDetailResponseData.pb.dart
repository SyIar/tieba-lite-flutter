...
class GetForumDetailResponseData extends $pb.GeneratedMessage {
  factory GetForumDetailResponseData({
    ...
    final result = GetForumDetailResponseData._();
  ...
  @$core.Deprecated(
      'Use GetForumDetailResponseData() / GetForumDetailResponseData.new instead')
  static GetForumDetailResponseData create() => GetForumDetailResponseData._();
  static $pb.GeneratedMessage $_createMessage() =>
      GetForumDetailResponseData._();
  @$core.override
  GetForumDetailResponseData createEmptyInstance() =>
      GetForumDetailResponseData._();
  @$core.pragma('dart2js:noInline')
  static GetForumDetailResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetForumDetailResponseData>(
          GetForumDetailResponseData.$_createMessage);

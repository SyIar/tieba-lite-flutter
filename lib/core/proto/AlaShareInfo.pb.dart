...
class AlaShareInfo extends $pb.GeneratedMessage {
  ...
  factory AlaShareInfo.fromBuffer($core.List<$core.int> data,
      ...
      AlaShareInfo()..mergeFromBuffer(data, registry);
  factory AlaShareInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AlaShareInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AlaShareInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AlaShareInfo.$_createMessage)
  ...
  @$core.Deprecated('Use AlaShareInfo() / AlaShareInfo.new instead')
  static AlaShareInfo create() => AlaShareInfo._();
  static $pb.GeneratedMessage $_createMessage() => AlaShareInfo._();
  @$core.override
  AlaShareInfo createEmptyInstance() => AlaShareInfo._();
  @$core.pragma('dart2js:noInline')
  static AlaShareInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AlaShareInfo>(
          AlaShareInfo.$_createMessage);

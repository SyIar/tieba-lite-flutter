...
class ManagerElection extends $pb.GeneratedMessage {
  factory ManagerElection({
    ...
    final result = ManagerElection._();
  ...
  factory ManagerElection.fromBuffer($core.List<$core.int> data,
      ...
      ManagerElection()..mergeFromBuffer(data, registry);
  factory ManagerElection.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ManagerElection()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ManagerElection',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ManagerElection.$_createMessage)
  ...
  @$core.Deprecated('Use ManagerElection() / ManagerElection.new instead')
  static ManagerElection create() => ManagerElection._();
  static $pb.GeneratedMessage $_createMessage() => ManagerElection._();
  @$core.override
  ManagerElection createEmptyInstance() => ManagerElection._();
  @$core.pragma('dart2js:noInline')
  static ManagerElection getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ManagerElection>(
          ManagerElection.$_createMessage);

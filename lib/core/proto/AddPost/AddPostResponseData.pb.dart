...
class AddPostResponseData extends $pb.GeneratedMessage {
  factory AddPostResponseData({
    ...
    final result = AddPostResponseData._();
  ...
  @$core
      .Deprecated('Use AddPostResponseData() / AddPostResponseData.new instead')
  static AddPostResponseData create() => AddPostResponseData._();
  static $pb.GeneratedMessage $_createMessage() => AddPostResponseData._();
  @$core.override
  AddPostResponseData createEmptyInstance() => AddPostResponseData._();
  @$core.pragma('dart2js:noInline')
  static AddPostResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AddPostResponseData>(
          AddPostResponseData.$_createMessage);

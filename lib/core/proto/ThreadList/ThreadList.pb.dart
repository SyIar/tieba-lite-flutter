...
class ThreadListRequestData extends $pb.GeneratedMessage {
  factory ThreadListRequestData({
    ...
    final result = ThreadListRequestData._();
  ...
  @$core.Deprecated(
      'Use ThreadListRequestData() / ThreadListRequestData.new instead')
  static ThreadListRequestData create() => ThreadListRequestData._();
  static $pb.GeneratedMessage $_createMessage() => ThreadListRequestData._();
  @$core.override
  ThreadListRequestData createEmptyInstance() => ThreadListRequestData._();
  @$core.pragma('dart2js:noInline')
  static ThreadListRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ThreadListRequestData>(
          ThreadListRequestData.$_createMessage);
...
class ThreadListRequest extends $pb.GeneratedMessage {
  factory ThreadListRequest({
    ...
    final result = ThreadListRequest._();
  ...
  factory ThreadListRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadListRequest()..mergeFromBuffer(data, registry);
  factory ThreadListRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadListRequest()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThreadListRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'tieba.threadList'),
      createEmptyInstance: ThreadListRequest.$_createMessage)
    ..aOM<ThreadListRequestData>(1, _omitFieldNames ? '' : 'data',
        subBuilder: ThreadListRequestData.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use ThreadListRequest() / ThreadListRequest.new instead')
  static ThreadListRequest create() => ThreadListRequest._();
  static $pb.GeneratedMessage $_createMessage() => ThreadListRequest._();
  @$core.override
  ThreadListRequest createEmptyInstance() => ThreadListRequest._();
  @$core.pragma('dart2js:noInline')
  static ThreadListRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThreadListRequest>(
          ThreadListRequest.$_createMessage);
...
class ThreadListResponseData extends $pb.GeneratedMessage {
  factory ThreadListResponseData({
    ...
    final result = ThreadListResponseData._();
  ...
  factory ThreadListResponseData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadListResponseData()..mergeFromBuffer(data, registry);
  factory ThreadListResponseData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadListResponseData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThreadListResponseData',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'tieba.threadList'),
      createEmptyInstance: ThreadListResponseData.$_createMessage)
    ..pPM<$3.ThreadInfo>(1, _omitFieldNames ? '' : 'threadList',
        subBuilder: $3.ThreadInfo.$_createMessage)
    ..pPM<$4.User>(2, _omitFieldNames ? '' : 'userList',
        subBuilder: $4.User.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated(
      'Use ThreadListResponseData() / ThreadListResponseData.new instead')
  static ThreadListResponseData create() => ThreadListResponseData._();
  static $pb.GeneratedMessage $_createMessage() => ThreadListResponseData._();
  @$core.override
  ThreadListResponseData createEmptyInstance() => ThreadListResponseData._();
  @$core.pragma('dart2js:noInline')
  static ThreadListResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ThreadListResponseData>(
          ThreadListResponseData.$_createMessage);
...
class ThreadListResponse extends $pb.GeneratedMessage {
  factory ThreadListResponse({
    ...
    final result = ThreadListResponse._();
  ...
  factory ThreadListResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadListResponse()..mergeFromBuffer(data, registry);
  factory ThreadListResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadListResponse()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThreadListResponse',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'tieba.threadList'),
      createEmptyInstance: ThreadListResponse.$_createMessage)
    ..aOM<$5.Error>(1, _omitFieldNames ? '' : 'error',
        subBuilder: $5.Error.$_createMessage)
    ..aOM<ThreadListResponseData>(2, _omitFieldNames ? '' : 'data',
        subBuilder: ThreadListResponseData.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use ThreadListResponse() / ThreadListResponse.new instead')
  static ThreadListResponse create() => ThreadListResponse._();
  static $pb.GeneratedMessage $_createMessage() => ThreadListResponse._();
  @$core.override
  ThreadListResponse createEmptyInstance() => ThreadListResponse._();
  @$core.pragma('dart2js:noInline')
  static ThreadListResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ThreadListResponse>(
          ThreadListResponse.$_createMessage);

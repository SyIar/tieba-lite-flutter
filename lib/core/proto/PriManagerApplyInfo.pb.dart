...
class PriManagerApplyInfo extends $pb.GeneratedMessage {
  factory PriManagerApplyInfo({
    ...
    final result = PriManagerApplyInfo._();
  ...
  factory PriManagerApplyInfo.fromBuffer($core.List<$core.int> data,
      ...
      PriManagerApplyInfo()..mergeFromBuffer(data, registry);
  factory PriManagerApplyInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PriManagerApplyInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PriManagerApplyInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PriManagerApplyInfo.$_createMessage)
  ...
  @$core
      .Deprecated('Use PriManagerApplyInfo() / PriManagerApplyInfo.new instead')
  static PriManagerApplyInfo create() => PriManagerApplyInfo._();
  static $pb.GeneratedMessage $_createMessage() => PriManagerApplyInfo._();
  @$core.override
  PriManagerApplyInfo createEmptyInstance() => PriManagerApplyInfo._();
  @$core.pragma('dart2js:noInline')
  static PriManagerApplyInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PriManagerApplyInfo>(
          PriManagerApplyInfo.$_createMessage);

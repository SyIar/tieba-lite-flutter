...
class GetBawuInfoResponse extends $pb.GeneratedMessage {
  factory GetBawuInfoResponse({
    ...
    final result = GetBawuInfoResponse._();
  ...
  @$core
      .Deprecated('Use GetBawuInfoResponse() / GetBawuInfoResponse.new instead')
  static GetBawuInfoResponse create() => GetBawuInfoResponse._();
  static $pb.GeneratedMessage $_createMessage() => GetBawuInfoResponse._();
  @$core.override
  GetBawuInfoResponse createEmptyInstance() => GetBawuInfoResponse._();
  @$core.pragma('dart2js:noInline')
  static GetBawuInfoResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetBawuInfoResponse>(
          GetBawuInfoResponse.$_createMessage);

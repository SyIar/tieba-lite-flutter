...
class BawuTeam extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use BawuTeam() / BawuTeam.new instead')
  static BawuTeam create() => BawuTeam._();
  static $pb.GeneratedMessage $_createMessage() => BawuTeam._();
  @$core.override
  BawuTeam createEmptyInstance() => BawuTeam._();
  @$core.pragma('dart2js:noInline')
  static BawuTeam getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BawuTeam>(BawuTeam.$_createMessage);

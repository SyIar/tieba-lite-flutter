...
class RecomThreadList extends $pb.GeneratedMessage {
  factory RecomThreadList({
    ...
    final result = RecomThreadList._();
  ...
  @$core.Deprecated('Use RecomThreadList() / RecomThreadList.new instead')
  static RecomThreadList create() => RecomThreadList._();
  static $pb.GeneratedMessage $_createMessage() => RecomThreadList._();
  @$core.override
  RecomThreadList createEmptyInstance() => RecomThreadList._();
  @$core.pragma('dart2js:noInline')
  static RecomThreadList getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecomThreadList>(
          RecomThreadList.$_createMessage);

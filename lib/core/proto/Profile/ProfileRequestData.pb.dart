...
class ProfileRequestData extends $pb.GeneratedMessage {
  factory ProfileRequestData({
    ...
    final result = ProfileRequestData._();
  ...
  @$core.Deprecated('Use ProfileRequestData() / ProfileRequestData.new instead')
  static ProfileRequestData create() => ProfileRequestData._();
  static $pb.GeneratedMessage $_createMessage() => ProfileRequestData._();
  @$core.override
  ProfileRequestData createEmptyInstance() => ProfileRequestData._();
  @$core.pragma('dart2js:noInline')
  static ProfileRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfileRequestData>(
          ProfileRequestData.$_createMessage);

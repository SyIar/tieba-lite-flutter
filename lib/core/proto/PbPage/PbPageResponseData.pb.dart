...
class PbPageResponseData extends $pb.GeneratedMessage {
  factory PbPageResponseData({
    ...
    final result = PbPageResponseData._();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$24.FeedExtInfo>(33, _omitFieldNames ? '' : 'feedInfo',
        subBuilder: $24.FeedExtInfo.$_createMessage)
    ..aOM<$25.PbTopAgreePost>(34, _omitFieldNames ? '' : 'topAgreePostList',
        subBuilder: $25.PbTopAgreePost.$_createMessage)
    ...
    ..aOM<$36.FloatingIcon>(64, _omitFieldNames ? '' : 'floatingIcon',
        subBuilder: $36.FloatingIcon.$_createMessage)
  ...
  @$core.Deprecated('Use PbPageResponseData() / PbPageResponseData.new instead')
  static PbPageResponseData create() => PbPageResponseData._();
  static $pb.GeneratedMessage $_createMessage() => PbPageResponseData._();
  @$core.override
  PbPageResponseData createEmptyInstance() => PbPageResponseData._();
  @$core.pragma('dart2js:noInline')
  static PbPageResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbPageResponseData>(
          PbPageResponseData.$_createMessage);

...
class TogetherHi extends $pb.GeneratedMessage {
  ...
  factory TogetherHi.fromBuffer($core.List<$core.int> data,
      ...
      TogetherHi()..mergeFromBuffer(data, registry);
  factory TogetherHi.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      TogetherHi()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TogetherHi',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: TogetherHi.$_createMessage)
  ...
  @$core.Deprecated('Use TogetherHi() / TogetherHi.new instead')
  static TogetherHi create() => TogetherHi._();
  static $pb.GeneratedMessage $_createMessage() => TogetherHi._();
  @$core.override
  TogetherHi createEmptyInstance() => TogetherHi._();
  @$core.pragma('dart2js:noInline')
  static TogetherHi getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TogetherHi>(TogetherHi.$_createMessage);

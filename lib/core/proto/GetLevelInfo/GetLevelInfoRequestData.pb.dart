...
class GetLevelInfoRequestData extends $pb.GeneratedMessage {
  factory GetLevelInfoRequestData({
    ...
    final result = GetLevelInfoRequestData._();
  ...
  @$core.Deprecated(
      'Use GetLevelInfoRequestData() / GetLevelInfoRequestData.new instead')
  static GetLevelInfoRequestData create() => GetLevelInfoRequestData._();
  static $pb.GeneratedMessage $_createMessage() => GetLevelInfoRequestData._();
  @$core.override
  GetLevelInfoRequestData createEmptyInstance() => GetLevelInfoRequestData._();
  @$core.pragma('dart2js:noInline')
  static GetLevelInfoRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetLevelInfoRequestData>(
          GetLevelInfoRequestData.$_createMessage);

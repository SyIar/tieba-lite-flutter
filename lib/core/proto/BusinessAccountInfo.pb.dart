...
class BusinessAccountInfo extends $pb.GeneratedMessage {
  factory BusinessAccountInfo({
    ...
    final result = BusinessAccountInfo._();
  ...
  factory BusinessAccountInfo.fromBuffer($core.List<$core.int> data,
      ...
      BusinessAccountInfo()..mergeFromBuffer(data, registry);
  factory BusinessAccountInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BusinessAccountInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BusinessAccountInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BusinessAccountInfo.$_createMessage)
  ...
  @$core
      .Deprecated('Use BusinessAccountInfo() / BusinessAccountInfo.new instead')
  static BusinessAccountInfo create() => BusinessAccountInfo._();
  static $pb.GeneratedMessage $_createMessage() => BusinessAccountInfo._();
  @$core.override
  BusinessAccountInfo createEmptyInstance() => BusinessAccountInfo._();
  @$core.pragma('dart2js:noInline')
  static BusinessAccountInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BusinessAccountInfo>(
          BusinessAccountInfo.$_createMessage);

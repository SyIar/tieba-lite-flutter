...
class Anti extends $pb.GeneratedMessage {
  ...
  factory Anti.fromBuffer($core.List<$core.int> data,
      ...
      Anti()..mergeFromBuffer(data, registry);
  factory Anti.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Anti()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Anti',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Anti.$_createMessage)
    ...
    ..pPM<$0.DelThreadText>(24, _omitFieldNames ? '' : 'delThreadText',
        subBuilder: $0.DelThreadText.$_createMessage)
  ...
  @$core.Deprecated('Use Anti() / Anti.new instead')
  static Anti create() => Anti._();
  static $pb.GeneratedMessage $_createMessage() => Anti._();
  @$core.override
  Anti createEmptyInstance() => Anti._();
  @$core.pragma('dart2js:noInline')
  static Anti getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Anti>(Anti.$_createMessage);

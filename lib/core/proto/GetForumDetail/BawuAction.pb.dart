...
class BawuAction extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use BawuAction() / BawuAction.new instead')
  static BawuAction create() => BawuAction._();
  static $pb.GeneratedMessage $_createMessage() => BawuAction._();
  @$core.override
  BawuAction createEmptyInstance() => BawuAction._();
  @$core.pragma('dart2js:noInline')
  static BawuAction getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BawuAction>(BawuAction.$_createMessage);

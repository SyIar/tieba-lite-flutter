...
class PbFloorResponseData extends $pb.GeneratedMessage {
  factory PbFloorResponseData({
    ...
    final result = PbFloorResponseData._();
  ...
  factory PbFloorResponseData.fromBuffer($core.List<$core.int> data,
      ...
      PbFloorResponseData()..mergeFromBuffer(data, registry);
  factory PbFloorResponseData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PbFloorResponseData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PbFloorResponseData',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba.pbFloor'),
      createEmptyInstance: PbFloorResponseData.$_createMessage)
    ..aOM<$0.Page>(1, _omitFieldNames ? '' : 'page',
        subBuilder: $0.Page.$_createMessage)
    ..aOM<$1.Anti>(2, _omitFieldNames ? '' : 'anti',
        subBuilder: $1.Anti.$_createMessage)
    ..aOM<$2.Post>(3, _omitFieldNames ? '' : 'post',
        subBuilder: $2.Post.$_createMessage)
    ..pPM<$3.SubPostList>(4, _omitFieldNames ? '' : 'subpostList',
        subBuilder: $3.SubPostList.$_createMessage)
    ..aOM<$4.ThreadInfo>(5, _omitFieldNames ? '' : 'thread',
        subBuilder: $4.ThreadInfo.$_createMessage)
    ..aOM<$5.SimpleForum>(6, _omitFieldNames ? '' : 'forum',
        subBuilder: $5.SimpleForum.$_createMessage)
  ...
  @$core
      .Deprecated('Use PbFloorResponseData() / PbFloorResponseData.new instead')
  static PbFloorResponseData create() => PbFloorResponseData._();
  static $pb.GeneratedMessage $_createMessage() => PbFloorResponseData._();
  @$core.override
  PbFloorResponseData createEmptyInstance() => PbFloorResponseData._();
  @$core.pragma('dart2js:noInline')
  static PbFloorResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbFloorResponseData>(
          PbFloorResponseData.$_createMessage);

...
class PbPresent extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use PbPresent() / PbPresent.new instead')
  static PbPresent create() => PbPresent._();
  static $pb.GeneratedMessage $_createMessage() => PbPresent._();
  @$core.override
  PbPresent createEmptyInstance() => PbPresent._();
  @$core.pragma('dart2js:noInline')
  static PbPresent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbPresent>(PbPresent.$_createMessage);

...
class UserAgreeInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use UserAgreeInfo() / UserAgreeInfo.new instead')
  static UserAgreeInfo create() => UserAgreeInfo._();
  static $pb.GeneratedMessage $_createMessage() => UserAgreeInfo._();
  @$core.override
  UserAgreeInfo createEmptyInstance() => UserAgreeInfo._();
  @$core.pragma('dart2js:noInline')
  static UserAgreeInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserAgreeInfo>(
          UserAgreeInfo.$_createMessage);

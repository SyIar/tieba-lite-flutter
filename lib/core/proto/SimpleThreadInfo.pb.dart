...
class SimpleThreadInfo extends $pb.GeneratedMessage {
  factory SimpleThreadInfo({
    ...
    final result = SimpleThreadInfo._();
  ...
  factory SimpleThreadInfo.fromBuffer($core.List<$core.int> data,
      ...
      SimpleThreadInfo()..mergeFromBuffer(data, registry);
  factory SimpleThreadInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      SimpleThreadInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SimpleThreadInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: SimpleThreadInfo.$_createMessage)
    ...
    ..pPM<$0.Abstract>(5, _omitFieldNames ? '' : 'Abstract',
        subBuilder: $0.Abstract.$_createMessage)
    ..aOM<$1.Zan>(6, _omitFieldNames ? '' : 'zan',
        subBuilder: $1.Zan.$_createMessage)
    ..a<$fixnum.Int64>(
  ...
  @$core.Deprecated('Use SimpleThreadInfo() / SimpleThreadInfo.new instead')
  static SimpleThreadInfo create() => SimpleThreadInfo._();
  static $pb.GeneratedMessage $_createMessage() => SimpleThreadInfo._();
  @$core.override
  SimpleThreadInfo createEmptyInstance() => SimpleThreadInfo._();
  @$core.pragma('dart2js:noInline')
  static SimpleThreadInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SimpleThreadInfo>(
          SimpleThreadInfo.$_createMessage);

...
class RecommendThread extends $pb.GeneratedMessage {
  factory RecommendThread({
    ...
    final result = RecommendThread._();
  ...
  factory RecommendThread.fromBuffer($core.List<$core.int> data,
      ...
      RecommendThread()..mergeFromBuffer(data, registry);
  factory RecommendThread.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      RecommendThread()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RecommendThread',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: RecommendThread.$_createMessage)
  ...
  @$core.Deprecated('Use RecommendThread() / RecommendThread.new instead')
  static RecommendThread create() => RecommendThread._();
  static $pb.GeneratedMessage $_createMessage() => RecommendThread._();
  @$core.override
  RecommendThread createEmptyInstance() => RecommendThread._();
  @$core.pragma('dart2js:noInline')
  static RecommendThread getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecommendThread>(
          RecommendThread.$_createMessage);

...
class GetHistoryForumRequest extends $pb.GeneratedMessage {
  factory GetHistoryForumRequest({
    ...
    final result = GetHistoryForumRequest._();
  ...
  factory GetHistoryForumRequest.fromBuffer($core.List<$core.int> data,
      ...
      GetHistoryForumRequest()..mergeFromBuffer(data, registry);
  factory GetHistoryForumRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      GetHistoryForumRequest()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetHistoryForumRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.getHistoryForum'),
      createEmptyInstance: GetHistoryForumRequest.$_createMessage)
    ..aOM<$0.GetHistoryForumRequestData>(1, _omitFieldNames ? '' : 'data',
        subBuilder: $0.GetHistoryForumRequestData.$_createMessage)
  ...
  @$core.Deprecated(
      'Use GetHistoryForumRequest() / GetHistoryForumRequest.new instead')
  static GetHistoryForumRequest create() => GetHistoryForumRequest._();
  static $pb.GeneratedMessage $_createMessage() => GetHistoryForumRequest._();
  @$core.override
  GetHistoryForumRequest createEmptyInstance() => GetHistoryForumRequest._();
  @$core.pragma('dart2js:noInline')
  static GetHistoryForumRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetHistoryForumRequest>(
          GetHistoryForumRequest.$_createMessage);

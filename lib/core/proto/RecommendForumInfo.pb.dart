...
class RecommendForumInfo extends $pb.GeneratedMessage {
  factory RecommendForumInfo({
    ...
    final result = RecommendForumInfo._();
  ...
  factory RecommendForumInfo.fromBuffer($core.List<$core.int> data,
      ...
      RecommendForumInfo()..mergeFromBuffer(data, registry);
  factory RecommendForumInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      RecommendForumInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RecommendForumInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: RecommendForumInfo.$_createMessage)
  ...
  @$core.Deprecated('Use RecommendForumInfo() / RecommendForumInfo.new instead')
  static RecommendForumInfo create() => RecommendForumInfo._();
  static $pb.GeneratedMessage $_createMessage() => RecommendForumInfo._();
  @$core.override
  RecommendForumInfo createEmptyInstance() => RecommendForumInfo._();
  @$core.pragma('dart2js:noInline')
  static RecommendForumInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RecommendForumInfo>(
          RecommendForumInfo.$_createMessage);

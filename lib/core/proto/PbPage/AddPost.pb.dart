...
class AddPost extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use AddPost() / AddPost.new instead')
  static AddPost create() => AddPost._();
  static $pb.GeneratedMessage $_createMessage() => AddPost._();
  @$core.override
  AddPost createEmptyInstance() => AddPost._();
  @$core.pragma('dart2js:noInline')
  static AddPost getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AddPost>(AddPost.$_createMessage);

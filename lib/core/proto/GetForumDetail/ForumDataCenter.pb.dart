...
class ForumDataCenter extends $pb.GeneratedMessage {
  factory ForumDataCenter({
    ...
    final result = ForumDataCenter._();
  ...
  factory ForumDataCenter.fromBuffer($core.List<$core.int> data,
      ...
      ForumDataCenter()..mergeFromBuffer(data, registry);
  factory ForumDataCenter.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumDataCenter()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumDataCenter',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.getForumDetail'),
      createEmptyInstance: ForumDataCenter.$_createMessage)
  ...
  @$core.Deprecated('Use ForumDataCenter() / ForumDataCenter.new instead')
  static ForumDataCenter create() => ForumDataCenter._();
  static $pb.GeneratedMessage $_createMessage() => ForumDataCenter._();
  @$core.override
  ForumDataCenter createEmptyInstance() => ForumDataCenter._();
  @$core.pragma('dart2js:noInline')
  static ForumDataCenter getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ForumDataCenter>(
          ForumDataCenter.$_createMessage);

...
class AddPostResponse extends $pb.GeneratedMessage {
  factory AddPostResponse({
    ...
    final result = AddPostResponse._();
  ...
  @$core.Deprecated('Use AddPostResponse() / AddPostResponse.new instead')
  static AddPostResponse create() => AddPostResponse._();
  static $pb.GeneratedMessage $_createMessage() => AddPostResponse._();
  @$core.override
  AddPostResponse createEmptyInstance() => AddPostResponse._();
  @$core.pragma('dart2js:noInline')
  static AddPostResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AddPostResponse>(
          AddPostResponse.$_createMessage);

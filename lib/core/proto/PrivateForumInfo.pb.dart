...
class PrivateForumInfo extends $pb.GeneratedMessage {
  factory PrivateForumInfo({
    ...
    final result = PrivateForumInfo._();
  ...
  factory PrivateForumInfo.fromBuffer($core.List<$core.int> data,
      ...
      PrivateForumInfo()..mergeFromBuffer(data, registry);
  factory PrivateForumInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PrivateForumInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PrivateForumInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PrivateForumInfo.$_createMessage)
  ...
  @$core.Deprecated('Use PrivateForumInfo() / PrivateForumInfo.new instead')
  static PrivateForumInfo create() => PrivateForumInfo._();
  static $pb.GeneratedMessage $_createMessage() => PrivateForumInfo._();
  @$core.override
  PrivateForumInfo createEmptyInstance() => PrivateForumInfo._();
  @$core.pragma('dart2js:noInline')
  static PrivateForumInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PrivateForumInfo>(
          PrivateForumInfo.$_createMessage);

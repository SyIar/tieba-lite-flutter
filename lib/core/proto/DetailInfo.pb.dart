...
class DetailInfo extends $pb.GeneratedMessage {
  ...
  factory DetailInfo.fromBuffer($core.List<$core.int> data,
      ...
      DetailInfo()..mergeFromBuffer(data, registry);
  factory DetailInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      DetailInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DetailInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: DetailInfo.$_createMessage)
  ...
  @$core.Deprecated('Use DetailInfo() / DetailInfo.new instead')
  static DetailInfo create() => DetailInfo._();
  static $pb.GeneratedMessage $_createMessage() => DetailInfo._();
  @$core.override
  DetailInfo createEmptyInstance() => DetailInfo._();
  @$core.pragma('dart2js:noInline')
  static DetailInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DetailInfo>(DetailInfo.$_createMessage);

...
class MemeInfo extends $pb.GeneratedMessage {
  ...
  factory MemeInfo.fromBuffer($core.List<$core.int> data,
      ...
      MemeInfo()..mergeFromBuffer(data, registry);
  factory MemeInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      MemeInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MemeInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: MemeInfo.$_createMessage)
  ...
  @$core.Deprecated('Use MemeInfo() / MemeInfo.new instead')
  static MemeInfo create() => MemeInfo._();
  static $pb.GeneratedMessage $_createMessage() => MemeInfo._();
  @$core.override
  MemeInfo createEmptyInstance() => MemeInfo._();
  @$core.pragma('dart2js:noInline')
  static MemeInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MemeInfo>(MemeInfo.$_createMessage);

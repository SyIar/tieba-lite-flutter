...
class NaGuide extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use NaGuide() / NaGuide.new instead')
  static NaGuide create() => NaGuide._();
  static $pb.GeneratedMessage $_createMessage() => NaGuide._();
  @$core.override
  NaGuide createEmptyInstance() => NaGuide._();
  @$core.pragma('dart2js:noInline')
  static NaGuide getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NaGuide>(NaGuide.$_createMessage);

...
class RankingParam extends $pb.GeneratedMessage {
  ...
  factory RankingParam.fromBuffer($core.List<$core.int> data,
      ...
      RankingParam()..mergeFromBuffer(data, registry);
  factory RankingParam.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      RankingParam()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RankingParam',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: RankingParam.$_createMessage)
  ...
  @$core.Deprecated('Use RankingParam() / RankingParam.new instead')
  static RankingParam create() => RankingParam._();
  static $pb.GeneratedMessage $_createMessage() => RankingParam._();
  @$core.override
  RankingParam createEmptyInstance() => RankingParam._();
  @$core.pragma('dart2js:noInline')
  static RankingParam getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RankingParam>(
          RankingParam.$_createMessage);

...
class AlaLiveInfo extends $pb.GeneratedMessage {
  ...
  factory AlaLiveInfo.fromBuffer($core.List<$core.int> data,
      ...
      AlaLiveInfo()..mergeFromBuffer(data, registry);
  factory AlaLiveInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AlaLiveInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AlaLiveInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AlaLiveInfo.$_createMessage)
    ...
    ..aOM<$0.AlaUserInfo>(12, _omitFieldNames ? '' : 'userInfo',
        subBuilder: $0.AlaUserInfo.$_createMessage)
    ...
    ..aOM<$1.AlaShareInfo>(19, _omitFieldNames ? '' : 'shareInfo',
        subBuilder: $1.AlaShareInfo.$_createMessage)
    ..a<$fixnum.Int64>(
    ...
    ..pPM<$2.AlaStageDislikeInfo>(23, _omitFieldNames ? '' : 'stageDislikeInfo',
        subBuilder: $2.AlaStageDislikeInfo.$_createMessage)
    ..aOM<$3.AlaCoverLabel>(24, _omitFieldNames ? '' : 'label',
        subBuilder: $3.AlaCoverLabel.$_createMessage)
    ..aOM<$4.AlaChallengeInfo>(25, _omitFieldNames ? '' : 'challengeInfo',
        subBuilder: $4.AlaChallengeInfo.$_createMessage)
    ...
    ..pPM<$5.DislikeInfo>(43, _omitFieldNames ? '' : 'dislikeInfo',
        subBuilder: $5.DislikeInfo.$_createMessage)
    ...
    ..aOM<$6.YyExt>(49, _omitFieldNames ? '' : 'yyExt',
        subBuilder: $6.YyExt.$_createMessage)
  ...
  @$core.Deprecated('Use AlaLiveInfo() / AlaLiveInfo.new instead')
  static AlaLiveInfo create() => AlaLiveInfo._();
  static $pb.GeneratedMessage $_createMessage() => AlaLiveInfo._();
  @$core.override
  AlaLiveInfo createEmptyInstance() => AlaLiveInfo._();
  @$core.pragma('dart2js:noInline')
  static AlaLiveInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AlaLiveInfo>(
          AlaLiveInfo.$_createMessage);

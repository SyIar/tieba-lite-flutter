...
class Timgs extends $pb.GeneratedMessage {
  ...
  factory Timgs.fromBuffer($core.List<$core.int> data,
      ...
      Timgs()..mergeFromBuffer(data, registry);
  factory Timgs.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      Timgs()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Timgs',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: Timgs.$_createMessage)
  ...
  @$core.Deprecated('Use Timgs() / Timgs.new instead')
  static Timgs create() => Timgs._();
  static $pb.GeneratedMessage $_createMessage() => Timgs._();
  @$core.override
  Timgs createEmptyInstance() => Timgs._();
  @$core.pragma('dart2js:noInline')
  static Timgs getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Timgs>(Timgs.$_createMessage);

...
class RecomTopicInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use RecomTopicInfo() / RecomTopicInfo.new instead')
  static RecomTopicInfo create() => RecomTopicInfo._();
  static $pb.GeneratedMessage $_createMessage() => RecomTopicInfo._();
  @$core.override
  RecomTopicInfo createEmptyInstance() => RecomTopicInfo._();
  @$core.pragma('dart2js:noInline')
  static RecomTopicInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecomTopicInfo>(
          RecomTopicInfo.$_createMessage);

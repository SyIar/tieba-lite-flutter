...
class NewGodInfo extends $pb.GeneratedMessage {
  ...
  factory NewGodInfo.fromBuffer($core.List<$core.int> data,
      ...
      NewGodInfo()..mergeFromBuffer(data, registry);
  factory NewGodInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      NewGodInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'NewGodInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: NewGodInfo.$_createMessage)
  ...
  @$core.Deprecated('Use NewGodInfo() / NewGodInfo.new instead')
  static NewGodInfo create() => NewGodInfo._();
  static $pb.GeneratedMessage $_createMessage() => NewGodInfo._();
  @$core.override
  NewGodInfo createEmptyInstance() => NewGodInfo._();
  @$core.pragma('dart2js:noInline')
  static NewGodInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NewGodInfo>(NewGodInfo.$_createMessage);

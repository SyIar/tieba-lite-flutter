...
class SignUser extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use SignUser() / SignUser.new instead')
  static SignUser create() => SignUser._();
  static $pb.GeneratedMessage $_createMessage() => SignUser._();
  @$core.override
  SignUser createEmptyInstance() => SignUser._();
  @$core.pragma('dart2js:noInline')
  static SignUser getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SignUser>(SignUser.$_createMessage);

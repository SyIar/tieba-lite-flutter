...
class UcCard extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use UcCard() / UcCard.new instead')
  static UcCard create() => UcCard._();
  static $pb.GeneratedMessage $_createMessage() => UcCard._();
  @$core.override
  UcCard createEmptyInstance() => UcCard._();
  @$core.pragma('dart2js:noInline')
  static UcCard getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UcCard>(UcCard.$_createMessage);

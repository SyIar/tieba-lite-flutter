...
class UserPostRequest extends $pb.GeneratedMessage {
  factory UserPostRequest({
    ...
    final result = UserPostRequest._();
  ...
  @$core.Deprecated('Use UserPostRequest() / UserPostRequest.new instead')
  static UserPostRequest create() => UserPostRequest._();
  static $pb.GeneratedMessage $_createMessage() => UserPostRequest._();
  @$core.override
  UserPostRequest createEmptyInstance() => UserPostRequest._();
  @$core.pragma('dart2js:noInline')
  static UserPostRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserPostRequest>(
          UserPostRequest.$_createMessage);

...
class ForumInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use ForumInfo() / ForumInfo.new instead')
  static ForumInfo create() => ForumInfo._();
  static $pb.GeneratedMessage $_createMessage() => ForumInfo._();
  @$core.override
  ForumInfo createEmptyInstance() => ForumInfo._();
  @$core.pragma('dart2js:noInline')
  static ForumInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForumInfo>(ForumInfo.$_createMessage);

...
class PostPrefix extends $pb.GeneratedMessage {
  ...
  factory PostPrefix.fromBuffer($core.List<$core.int> data,
      ...
      PostPrefix()..mergeFromBuffer(data, registry);
  factory PostPrefix.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PostPrefix()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PostPrefix',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PostPrefix.$_createMessage)
  ...
  @$core.Deprecated('Use PostPrefix() / PostPrefix.new instead')
  static PostPrefix create() => PostPrefix._();
  static $pb.GeneratedMessage $_createMessage() => PostPrefix._();
  @$core.override
  PostPrefix createEmptyInstance() => PostPrefix._();
  @$core.pragma('dart2js:noInline')
  static PostPrefix getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PostPrefix>(PostPrefix.$_createMessage);

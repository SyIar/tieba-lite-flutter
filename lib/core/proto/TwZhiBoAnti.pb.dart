...
class TwZhiBoAnti extends $pb.GeneratedMessage {
  ...
  factory TwZhiBoAnti.fromBuffer($core.List<$core.int> data,
      ...
      TwZhiBoAnti()..mergeFromBuffer(data, registry);
  factory TwZhiBoAnti.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      TwZhiBoAnti()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TwZhiBoAnti',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: TwZhiBoAnti.$_createMessage)
  ...
  @$core.Deprecated('Use TwZhiBoAnti() / TwZhiBoAnti.new instead')
  static TwZhiBoAnti create() => TwZhiBoAnti._();
  static $pb.GeneratedMessage $_createMessage() => TwZhiBoAnti._();
  @$core.override
  TwZhiBoAnti createEmptyInstance() => TwZhiBoAnti._();
  @$core.pragma('dart2js:noInline')
  static TwZhiBoAnti getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TwZhiBoAnti>(
          TwZhiBoAnti.$_createMessage);

...
class HotUserRankEntry extends $pb.GeneratedMessage {
  factory HotUserRankEntry({
    ...
    final result = HotUserRankEntry._();
  ...
  factory HotUserRankEntry.fromBuffer($core.List<$core.int> data,
      ...
      HotUserRankEntry()..mergeFromBuffer(data, registry);
  factory HotUserRankEntry.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      HotUserRankEntry()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'HotUserRankEntry',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: HotUserRankEntry.$_createMessage)
    ..pPM<$0.ShortUserInfo>(1, _omitFieldNames ? '' : 'hotUser',
        subBuilder: $0.ShortUserInfo.$_createMessage)
  ...
  @$core.Deprecated('Use HotUserRankEntry() / HotUserRankEntry.new instead')
  static HotUserRankEntry create() => HotUserRankEntry._();
  static $pb.GeneratedMessage $_createMessage() => HotUserRankEntry._();
  @$core.override
  HotUserRankEntry createEmptyInstance() => HotUserRankEntry._();
  @$core.pragma('dart2js:noInline')
  static HotUserRankEntry getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HotUserRankEntry>(
          HotUserRankEntry.$_createMessage);

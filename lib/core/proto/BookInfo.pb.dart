...
class BookInfo extends $pb.GeneratedMessage {
  ...
  factory BookInfo.fromBuffer($core.List<$core.int> data,
      ...
      BookInfo()..mergeFromBuffer(data, registry);
  factory BookInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BookInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BookInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BookInfo.$_createMessage)
    ...
    ..pPM<$0.BookTag>(13, _omitFieldNames ? '' : 'tags',
        subBuilder: $0.BookTag.$_createMessage)
  ...
  @$core.Deprecated('Use BookInfo() / BookInfo.new instead')
  static BookInfo create() => BookInfo._();
  static $pb.GeneratedMessage $_createMessage() => BookInfo._();
  @$core.override
  BookInfo createEmptyInstance() => BookInfo._();
  @$core.pragma('dart2js:noInline')
  static BookInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BookInfo>(BookInfo.$_createMessage);

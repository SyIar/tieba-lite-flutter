...
class AppealInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use AppealInfo() / AppealInfo.new instead')
  static AppealInfo create() => AppealInfo._();
  static $pb.GeneratedMessage $_createMessage() => AppealInfo._();
  @$core.override
  AppealInfo createEmptyInstance() => AppealInfo._();
  @$core.pragma('dart2js:noInline')
  static AppealInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AppealInfo>(AppealInfo.$_createMessage);

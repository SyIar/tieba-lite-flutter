...
class ThreadModule extends $pb.GeneratedMessage {
  ...
  factory ThreadModule.fromBuffer($core.List<$core.int> data,
      ...
      ThreadModule()..mergeFromBuffer(data, registry);
  factory ThreadModule.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadModule()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThreadModule',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ThreadModule.$_createMessage)
  ...
  @$core.Deprecated('Use ThreadModule() / ThreadModule.new instead')
  static ThreadModule create() => ThreadModule._();
  static $pb.GeneratedMessage $_createMessage() => ThreadModule._();
  @$core.override
  ThreadModule createEmptyInstance() => ThreadModule._();
  @$core.pragma('dart2js:noInline')
  static ThreadModule getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThreadModule>(
          ThreadModule.$_createMessage);

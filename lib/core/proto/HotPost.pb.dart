...
class HotPost extends $pb.GeneratedMessage {
  ...
  factory HotPost.fromBuffer($core.List<$core.int> data,
      ...
      HotPost()..mergeFromBuffer(data, registry);
  factory HotPost.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      HotPost()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'HotPost',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: HotPost.$_createMessage)
    ..a<$fixnum.Int64>(
    ...
    ..aOM<$0.PbPostZan>(5, _omitFieldNames ? '' : 'postZan',
        subBuilder: $0.PbPostZan.$_createMessage)
    ..aI(6, _omitFieldNames ? '' : 'postNum')
    ..pPM<$1.PbContent>(7, _omitFieldNames ? '' : 'content',
        subBuilder: $1.PbContent.$_createMessage)
  ...
  @$core.Deprecated('Use HotPost() / HotPost.new instead')
  static HotPost create() => HotPost._();
  static $pb.GeneratedMessage $_createMessage() => HotPost._();
  @$core.override
  HotPost createEmptyInstance() => HotPost._();
  @$core.pragma('dart2js:noInline')
  static HotPost getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<HotPost>(HotPost.$_createMessage);

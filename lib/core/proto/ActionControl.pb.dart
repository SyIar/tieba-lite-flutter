...
class ActionControl extends $pb.GeneratedMessage {
  ...
  factory ActionControl.fromBuffer($core.List<$core.int> data,
      ...
      ActionControl()..mergeFromBuffer(data, registry);
  factory ActionControl.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ActionControl()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ActionControl',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ActionControl.$_createMessage)
  ...
  @$core.Deprecated('Use ActionControl() / ActionControl.new instead')
  static ActionControl create() => ActionControl._();
  static $pb.GeneratedMessage $_createMessage() => ActionControl._();
  @$core.override
  ActionControl createEmptyInstance() => ActionControl._();
  @$core.pragma('dart2js:noInline')
  static ActionControl getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ActionControl>(
          ActionControl.$_createMessage);

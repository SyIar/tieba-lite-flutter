...
class PbSortType extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use PbSortType() / PbSortType.new instead')
  static PbSortType create() => PbSortType._();
  static $pb.GeneratedMessage $_createMessage() => PbSortType._();
  @$core.override
  PbSortType createEmptyInstance() => PbSortType._();
  @$core.pragma('dart2js:noInline')
  static PbSortType getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbSortType>(PbSortType.$_createMessage);

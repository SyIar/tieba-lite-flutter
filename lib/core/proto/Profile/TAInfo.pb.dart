...
class TAInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.CommonDistance>(4, _omitFieldNames ? '' : 'distanceinfo',
        subBuilder: $0.CommonDistance.$_createMessage)
    ...
    ..pPM<$1.ReplyList>(8, _omitFieldNames ? '' : 'replyList',
        subBuilder: $1.ReplyList.$_createMessage)
    ...
    ..aOM<$2.CommonLocation>(10, _omitFieldNames ? '' : 'location',
        subBuilder: $2.CommonLocation.$_createMessage)
  ...
  @$core.Deprecated('Use TAInfo() / TAInfo.new instead')
  static TAInfo create() => TAInfo._();
  static $pb.GeneratedMessage $_createMessage() => TAInfo._();
  @$core.override
  TAInfo createEmptyInstance() => TAInfo._();
  @$core.pragma('dart2js:noInline')
  static TAInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TAInfo>(TAInfo.$_createMessage);

...
class ApplyStatus extends $pb.GeneratedMessage {
  ...
  factory ApplyStatus.fromBuffer($core.List<$core.int> data,
      ...
      ApplyStatus()..mergeFromBuffer(data, registry);
  factory ApplyStatus.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ApplyStatus()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ApplyStatus',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.getForumDetail'),
      createEmptyInstance: ApplyStatus.$_createMessage)
  ...
  @$core.Deprecated('Use ApplyStatus() / ApplyStatus.new instead')
  static ApplyStatus create() => ApplyStatus._();
  static $pb.GeneratedMessage $_createMessage() => ApplyStatus._();
  @$core.override
  ApplyStatus createEmptyInstance() => ApplyStatus._();
  @$core.pragma('dart2js:noInline')
  static ApplyStatus getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApplyStatus>(
          ApplyStatus.$_createMessage);

...
class ForumRule extends $pb.GeneratedMessage {
  ...
  factory ForumRule.fromBuffer($core.List<$core.int> data,
      ...
      ForumRule()..mergeFromBuffer(data, registry);
  factory ForumRule.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumRule()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumRule',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ForumRule.$_createMessage)
  ...
  @$core.Deprecated('Use ForumRule() / ForumRule.new instead')
  static ForumRule create() => ForumRule._();
  static $pb.GeneratedMessage $_createMessage() => ForumRule._();
  @$core.override
  ForumRule createEmptyInstance() => ForumRule._();
  @$core.pragma('dart2js:noInline')
  static ForumRule getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ForumRule>(ForumRule.$_createMessage);

...
class GetMemberInfoResponseData extends $pb.GeneratedMessage {
  factory GetMemberInfoResponseData({
    ...
    final result = GetMemberInfoResponseData._();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.PriManagerApplyInfo>(
        ...
        subBuilder: $4.PriManagerApplyInfo.$_createMessage)
  ...
  @$core.Deprecated(
      'Use GetMemberInfoResponseData() / GetMemberInfoResponseData.new instead')
  static GetMemberInfoResponseData create() => GetMemberInfoResponseData._();
  static $pb.GeneratedMessage $_createMessage() =>
      GetMemberInfoResponseData._();
  @$core.override
  GetMemberInfoResponseData createEmptyInstance() =>
      GetMemberInfoResponseData._();
  @$core.pragma('dart2js:noInline')
  static GetMemberInfoResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetMemberInfoResponseData>(
          GetMemberInfoResponseData.$_createMessage);

...
class ForumMember extends $pb.GeneratedMessage {
  ...
  factory ForumMember.fromBuffer($core.List<$core.int> data,
      ...
      ForumMember()..mergeFromBuffer(data, registry);
  factory ForumMember.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumMember()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumMember',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ForumMember.$_createMessage)
  ...
  @$core.Deprecated('Use ForumMember() / ForumMember.new instead')
  static ForumMember create() => ForumMember._();
  static $pb.GeneratedMessage $_createMessage() => ForumMember._();
  @$core.override
  ForumMember createEmptyInstance() => ForumMember._();
  @$core.pragma('dart2js:noInline')
  static ForumMember getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ForumMember>(
          ForumMember.$_createMessage);

...
class UniversityInfo extends $pb.GeneratedMessage {
  ...
  factory UniversityInfo.fromBuffer($core.List<$core.int> data,
      ...
      UniversityInfo()..mergeFromBuffer(data, registry);
  factory UniversityInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UniversityInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UniversityInfo',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.getForumDetail'),
      createEmptyInstance: UniversityInfo.$_createMessage)
  ...
  @$core.Deprecated('Use UniversityInfo() / UniversityInfo.new instead')
  static UniversityInfo create() => UniversityInfo._();
  static $pb.GeneratedMessage $_createMessage() => UniversityInfo._();
  @$core.override
  UniversityInfo createEmptyInstance() => UniversityInfo._();
  @$core.pragma('dart2js:noInline')
  static UniversityInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UniversityInfo>(
          UniversityInfo.$_createMessage);

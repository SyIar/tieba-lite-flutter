...
class Size extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use Size() / Size.new instead')
  static Size create() => Size._();
  static $pb.GeneratedMessage $_createMessage() => Size._();
  @$core.override
  Size createEmptyInstance() => Size._();
  @$core.pragma('dart2js:noInline')
  static Size getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Size>(Size.$_createMessage);

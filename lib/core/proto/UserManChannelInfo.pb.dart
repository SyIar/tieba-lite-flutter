...
class UserManChannelInfo extends $pb.GeneratedMessage {
  factory UserManChannelInfo({
    ...
    final result = UserManChannelInfo._();
  ...
  factory UserManChannelInfo.fromBuffer($core.List<$core.int> data,
      ...
      UserManChannelInfo()..mergeFromBuffer(data, registry);
  factory UserManChannelInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserManChannelInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserManChannelInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: UserManChannelInfo.$_createMessage)
  ...
  @$core.Deprecated('Use UserManChannelInfo() / UserManChannelInfo.new instead')
  static UserManChannelInfo create() => UserManChannelInfo._();
  static $pb.GeneratedMessage $_createMessage() => UserManChannelInfo._();
  @$core.override
  UserManChannelInfo createEmptyInstance() => UserManChannelInfo._();
  @$core.pragma('dart2js:noInline')
  static UserManChannelInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserManChannelInfo>(
          UserManChannelInfo.$_createMessage);

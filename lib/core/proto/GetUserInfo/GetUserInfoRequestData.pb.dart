...
class GetUserInfoRequestData extends $pb.GeneratedMessage {
  factory GetUserInfoRequestData({
    ...
    final result = GetUserInfoRequestData._();
  ...
  @$core.Deprecated(
      'Use GetUserInfoRequestData() / GetUserInfoRequestData.new instead')
  static GetUserInfoRequestData create() => GetUserInfoRequestData._();
  static $pb.GeneratedMessage $_createMessage() => GetUserInfoRequestData._();
  @$core.override
  GetUserInfoRequestData createEmptyInstance() => GetUserInfoRequestData._();
  @$core.pragma('dart2js:noInline')
  static GetUserInfoRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetUserInfoRequestData>(
          GetUserInfoRequestData.$_createMessage);

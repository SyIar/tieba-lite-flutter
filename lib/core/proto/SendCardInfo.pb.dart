...
class SendCardInfo extends $pb.GeneratedMessage {
  ...
  factory SendCardInfo.fromBuffer($core.List<$core.int> data,
      ...
      SendCardInfo()..mergeFromBuffer(data, registry);
  factory SendCardInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      SendCardInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SendCardInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: SendCardInfo.$_createMessage)
  ...
  @$core.Deprecated('Use SendCardInfo() / SendCardInfo.new instead')
  static SendCardInfo create() => SendCardInfo._();
  static $pb.GeneratedMessage $_createMessage() => SendCardInfo._();
  @$core.override
  SendCardInfo createEmptyInstance() => SendCardInfo._();
  @$core.pragma('dart2js:noInline')
  static SendCardInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SendCardInfo>(
          SendCardInfo.$_createMessage);

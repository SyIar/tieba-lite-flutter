...
class SugLiveInfo extends $pb.GeneratedMessage {
  ...
  factory SugLiveInfo.fromBuffer($core.List<$core.int> data,
      ...
      SugLiveInfo()..mergeFromBuffer(data, registry);
  factory SugLiveInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      SugLiveInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SugLiveInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: SugLiveInfo.$_createMessage)
    ..aOS(1, _omitFieldNames ? '' : 'word')
    ..aOM<$0.AlaLiveInfo>(2, _omitFieldNames ? '' : 'alaInfo',
        subBuilder: $0.AlaLiveInfo.$_createMessage)
  ...
  @$core.Deprecated('Use SugLiveInfo() / SugLiveInfo.new instead')
  static SugLiveInfo create() => SugLiveInfo._();
  static $pb.GeneratedMessage $_createMessage() => SugLiveInfo._();
  @$core.override
  SugLiveInfo createEmptyInstance() => SugLiveInfo._();
  @$core.pragma('dart2js:noInline')
  static SugLiveInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SugLiveInfo>(
          SugLiveInfo.$_createMessage);

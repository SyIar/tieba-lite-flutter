...
class HeadItem extends $pb.GeneratedMessage {
  ...
  factory HeadItem.fromBuffer($core.List<$core.int> data,
      ...
      HeadItem()..mergeFromBuffer(data, registry);
  factory HeadItem.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      HeadItem()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'HeadItem',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: HeadItem.$_createMessage)
  ...
  @$core.Deprecated('Use HeadItem() / HeadItem.new instead')
  static HeadItem create() => HeadItem._();
  static $pb.GeneratedMessage $_createMessage() => HeadItem._();
  @$core.override
  HeadItem createEmptyInstance() => HeadItem._();
  @$core.pragma('dart2js:noInline')
  static HeadItem getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<HeadItem>(HeadItem.$_createMessage);

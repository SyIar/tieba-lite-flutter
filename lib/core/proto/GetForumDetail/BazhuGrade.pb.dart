...
class BazhuGrade extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use BazhuGrade() / BazhuGrade.new instead')
  static BazhuGrade create() => BazhuGrade._();
  static $pb.GeneratedMessage $_createMessage() => BazhuGrade._();
  @$core.override
  BazhuGrade createEmptyInstance() => BazhuGrade._();
  @$core.pragma('dart2js:noInline')
  static BazhuGrade getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BazhuGrade>(BazhuGrade.$_createMessage);

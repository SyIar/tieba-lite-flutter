...
class ModuleInfo extends $pb.GeneratedMessage {
  ...
  factory ModuleInfo.fromBuffer($core.List<$core.int> data,
      ...
      ModuleInfo()..mergeFromBuffer(data, registry);
  factory ModuleInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ModuleInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ModuleInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ModuleInfo.$_createMessage)
    ..pPM<$0.ThreadModule>(1, _omitFieldNames ? '' : 'moduleList',
        subBuilder: $0.ThreadModule.$_createMessage)
  ...
  @$core.Deprecated('Use ModuleInfo() / ModuleInfo.new instead')
  static ModuleInfo create() => ModuleInfo._();
  static $pb.GeneratedMessage $_createMessage() => ModuleInfo._();
  @$core.override
  ModuleInfo createEmptyInstance() => ModuleInfo._();
  @$core.pragma('dart2js:noInline')
  static ModuleInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ModuleInfo>(ModuleInfo.$_createMessage);

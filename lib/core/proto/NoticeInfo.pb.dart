...
class NoticeInfo extends $pb.GeneratedMessage {
  ...
  factory NoticeInfo.fromBuffer($core.List<$core.int> data,
      ...
      NoticeInfo()..mergeFromBuffer(data, registry);
  factory NoticeInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      NoticeInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'NoticeInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: NoticeInfo.$_createMessage)
  ...
  @$core.Deprecated('Use NoticeInfo() / NoticeInfo.new instead')
  static NoticeInfo create() => NoticeInfo._();
  static $pb.GeneratedMessage $_createMessage() => NoticeInfo._();
  @$core.override
  NoticeInfo createEmptyInstance() => NoticeInfo._();
  @$core.pragma('dart2js:noInline')
  static NoticeInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NoticeInfo>(NoticeInfo.$_createMessage);

...
class SearchSugResponse extends $pb.GeneratedMessage {
  factory SearchSugResponse({
    ...
    final result = SearchSugResponse._();
  ...
  @$core.Deprecated('Use SearchSugResponse() / SearchSugResponse.new instead')
  static SearchSugResponse create() => SearchSugResponse._();
  static $pb.GeneratedMessage $_createMessage() => SearchSugResponse._();
  @$core.override
  SearchSugResponse createEmptyInstance() => SearchSugResponse._();
  @$core.pragma('dart2js:noInline')
  static SearchSugResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SearchSugResponse>(
          SearchSugResponse.$_createMessage);

...
class High extends $pb.GeneratedMessage {
  ...
  factory High.fromBuffer($core.List<$core.int> data,
      ...
      High()..mergeFromBuffer(data, registry);
  factory High.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      High()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'High',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: High.$_createMessage)
  ...
  @$core.Deprecated('Use High() / High.new instead')
  static High create() => High._();
  static $pb.GeneratedMessage $_createMessage() => High._();
  @$core.override
  High createEmptyInstance() => High._();
  @$core.pragma('dart2js:noInline')
  static High getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<High>(High.$_createMessage);

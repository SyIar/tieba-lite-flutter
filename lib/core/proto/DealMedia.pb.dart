...
class DealMedia extends $pb.GeneratedMessage {
  ...
  factory DealMedia.fromBuffer($core.List<$core.int> data,
      ...
      DealMedia()..mergeFromBuffer(data, registry);
  factory DealMedia.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      DealMedia()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DealMedia',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: DealMedia.$_createMessage)
  ...
  @$core.Deprecated('Use DealMedia() / DealMedia.new instead')
  static DealMedia create() => DealMedia._();
  static $pb.GeneratedMessage $_createMessage() => DealMedia._();
  @$core.override
  DealMedia createEmptyInstance() => DealMedia._();
  @$core.pragma('dart2js:noInline')
  static DealMedia getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DealMedia>(DealMedia.$_createMessage);

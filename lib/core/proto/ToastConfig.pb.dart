...
class ToastConfig extends $pb.GeneratedMessage {
  ...
  factory ToastConfig.fromBuffer($core.List<$core.int> data,
      ...
      ToastConfig()..mergeFromBuffer(data, registry);
  factory ToastConfig.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ToastConfig()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ToastConfig',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ToastConfig.$_createMessage)
  ...
  @$core.Deprecated('Use ToastConfig() / ToastConfig.new instead')
  static ToastConfig create() => ToastConfig._();
  static $pb.GeneratedMessage $_createMessage() => ToastConfig._();
  @$core.override
  ToastConfig createEmptyInstance() => ToastConfig._();
  @$core.pragma('dart2js:noInline')
  static ToastConfig getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ToastConfig>(
          ToastConfig.$_createMessage);

...
class VideoImageColor extends $pb.GeneratedMessage {
  factory VideoImageColor({
    ...
    final result = VideoImageColor._();
  ...
  @$core.Deprecated('Use VideoImageColor() / VideoImageColor.new instead')
  static VideoImageColor create() => VideoImageColor._();
  static $pb.GeneratedMessage $_createMessage() => VideoImageColor._();
  @$core.override
  VideoImageColor createEmptyInstance() => VideoImageColor._();
  @$core.pragma('dart2js:noInline')
  static VideoImageColor getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<VideoImageColor>(
          VideoImageColor.$_createMessage);

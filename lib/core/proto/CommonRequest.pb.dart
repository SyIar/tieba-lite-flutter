...
class CommonRequest extends $pb.GeneratedMessage {
  ...
  factory CommonRequest.fromBuffer($core.List<$core.int> data,
      ...
      CommonRequest()..mergeFromBuffer(data, registry);
  factory CommonRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      CommonRequest()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CommonRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: CommonRequest.$_createMessage)
  ...
  @$core.Deprecated('Use CommonRequest() / CommonRequest.new instead')
  static CommonRequest create() => CommonRequest._();
  static $pb.GeneratedMessage $_createMessage() => CommonRequest._();
  @$core.override
  CommonRequest createEmptyInstance() => CommonRequest._();
  @$core.pragma('dart2js:noInline')
  static CommonRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CommonRequest>(
          CommonRequest.$_createMessage);

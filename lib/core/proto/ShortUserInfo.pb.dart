...
class ShortUserInfo extends $pb.GeneratedMessage {
  ...
  factory ShortUserInfo.fromBuffer($core.List<$core.int> data,
      ...
      ShortUserInfo()..mergeFromBuffer(data, registry);
  factory ShortUserInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ShortUserInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ShortUserInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ShortUserInfo.$_createMessage)
  ...
  @$core.Deprecated('Use ShortUserInfo() / ShortUserInfo.new instead')
  static ShortUserInfo create() => ShortUserInfo._();
  static $pb.GeneratedMessage $_createMessage() => ShortUserInfo._();
  @$core.override
  ShortUserInfo createEmptyInstance() => ShortUserInfo._();
  @$core.pragma('dart2js:noInline')
  static ShortUserInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ShortUserInfo>(
          ShortUserInfo.$_createMessage);

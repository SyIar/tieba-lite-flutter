...
class TPointPost extends $pb.GeneratedMessage {
  ...
  factory TPointPost.fromBuffer($core.List<$core.int> data,
      ...
      TPointPost()..mergeFromBuffer(data, registry);
  factory TPointPost.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      TPointPost()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TPointPost',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: TPointPost.$_createMessage)
  ...
  @$core.Deprecated('Use TPointPost() / TPointPost.new instead')
  static TPointPost create() => TPointPost._();
  static $pb.GeneratedMessage $_createMessage() => TPointPost._();
  @$core.override
  TPointPost createEmptyInstance() => TPointPost._();
  @$core.pragma('dart2js:noInline')
  static TPointPost getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TPointPost>(TPointPost.$_createMessage);

...
class VcodeInfo extends $pb.GeneratedMessage {
  ...
  factory VcodeInfo.fromBuffer($core.List<$core.int> data,
      ...
      VcodeInfo()..mergeFromBuffer(data, registry);
  factory VcodeInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      VcodeInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'VcodeInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: VcodeInfo.$_createMessage)
    ...
    ..aOM<$0.VcodeExtra>(4, _omitFieldNames ? '' : 'vcodeExtra',
        subBuilder: $0.VcodeExtra.$_createMessage)
  ...
  @$core.Deprecated('Use VcodeInfo() / VcodeInfo.new instead')
  static VcodeInfo create() => VcodeInfo._();
  static $pb.GeneratedMessage $_createMessage() => VcodeInfo._();
  @$core.override
  VcodeInfo createEmptyInstance() => VcodeInfo._();
  @$core.pragma('dart2js:noInline')
  static VcodeInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VcodeInfo>(VcodeInfo.$_createMessage);

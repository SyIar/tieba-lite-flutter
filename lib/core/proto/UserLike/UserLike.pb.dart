...
class UserLikeRequestData extends $pb.GeneratedMessage {
  factory UserLikeRequestData({
    ...
    final result = UserLikeRequestData._();
  ...
  @$core
      .Deprecated('Use UserLikeRequestData() / UserLikeRequestData.new instead')
  static UserLikeRequestData create() => UserLikeRequestData._();
  static $pb.GeneratedMessage $_createMessage() => UserLikeRequestData._();
  @$core.override
  UserLikeRequestData createEmptyInstance() => UserLikeRequestData._();
  @$core.pragma('dart2js:noInline')
  static UserLikeRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserLikeRequestData>(
          UserLikeRequestData.$_createMessage);
...
class UserLikeRequest extends $pb.GeneratedMessage {
  factory UserLikeRequest({
    ...
    final result = UserLikeRequest._();
  ...
  factory UserLikeRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserLikeRequest()..mergeFromBuffer(data, registry);
  factory UserLikeRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserLikeRequest()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserLikeRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba.userLike'),
      createEmptyInstance: UserLikeRequest.$_createMessage)
    ..aOM<UserLikeRequestData>(1, _omitFieldNames ? '' : 'data',
        subBuilder: UserLikeRequestData.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use UserLikeRequest() / UserLikeRequest.new instead')
  static UserLikeRequest create() => UserLikeRequest._();
  static $pb.GeneratedMessage $_createMessage() => UserLikeRequest._();
  @$core.override
  UserLikeRequest createEmptyInstance() => UserLikeRequest._();
  @$core.pragma('dart2js:noInline')
  static UserLikeRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserLikeRequest>(
          UserLikeRequest.$_createMessage);
...
class UserLikeResponseData extends $pb.GeneratedMessage {
  factory UserLikeResponseData({
    ...
    final result = UserLikeResponseData._();
  ...
  factory UserLikeResponseData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserLikeResponseData()..mergeFromBuffer(data, registry);
  factory UserLikeResponseData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserLikeResponseData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserLikeResponseData',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba.userLike'),
      createEmptyInstance: UserLikeResponseData.$_createMessage)
    ..pPM<ConcernData>(1, _omitFieldNames ? '' : 'threadInfo',
        protoName: 'threadInfo', subBuilder: ConcernData.$_createMessage)
    ..aOS(2, _omitFieldNames ? '' : 'pageTag', protoName: 'pageTag')
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated(
      'Use UserLikeResponseData() / UserLikeResponseData.new instead')
  static UserLikeResponseData create() => UserLikeResponseData._();
  static $pb.GeneratedMessage $_createMessage() => UserLikeResponseData._();
  @$core.override
  UserLikeResponseData createEmptyInstance() => UserLikeResponseData._();
  @$core.pragma('dart2js:noInline')
  static UserLikeResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserLikeResponseData>(
          UserLikeResponseData.$_createMessage);
...
class UserLikeResponse extends $pb.GeneratedMessage {
  factory UserLikeResponse({
    ...
    final result = UserLikeResponse._();
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use UserLikeResponse() / UserLikeResponse.new instead')
  static UserLikeResponse create() => UserLikeResponse._();
  static $pb.GeneratedMessage $_createMessage() => UserLikeResponse._();
  @$core.override
  UserLikeResponse createEmptyInstance() => UserLikeResponse._();
  @$core.pragma('dart2js:noInline')
  static UserLikeResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserLikeResponse>(
          UserLikeResponse.$_createMessage);
...
class ConcernData extends $pb.GeneratedMessage {
  ...
  factory ConcernData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ConcernData()..mergeFromBuffer(data, registry);
  factory ConcernData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ConcernData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ConcernData',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba.userLike'),
      createEmptyInstance: ConcernData.$_createMessage)
    ..aOM<$2.ThreadInfo>(1, _omitFieldNames ? '' : 'threadList',
        protoName: 'threadList', subBuilder: $2.ThreadInfo.$_createMessage)
    ..aOM<PostData>(2, _omitFieldNames ? '' : 'postData',
        protoName: 'postData', subBuilder: PostData.$_createMessage)
    ...
    ..pPM<$3.User>(5, _omitFieldNames ? '' : 'recommendUserList',
        protoName: 'recommendUserList', subBuilder: $3.User.$_createMessage)
    ..hasRequiredFields = false;
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use ConcernData() / ConcernData.new instead')
  static ConcernData create() => ConcernData._();
  static $pb.GeneratedMessage $_createMessage() => ConcernData._();
  @$core.override
  ConcernData createEmptyInstance() => ConcernData._();
  @$core.pragma('dart2js:noInline')
  static ConcernData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ConcernData>(
          ConcernData.$_createMessage);
...
class PostData extends $pb.GeneratedMessage {
  ...
  @$core.pragma('dart2js:noInline')
  @$core.Deprecated('Use PostData() / PostData.new instead')
  static PostData create() => PostData._();
  static $pb.GeneratedMessage $_createMessage() => PostData._();
  @$core.override
  PostData createEmptyInstance() => PostData._();
  @$core.pragma('dart2js:noInline')
  static PostData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PostData>(PostData.$_createMessage);

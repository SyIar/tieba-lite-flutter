...
class LikeForumInfo extends $pb.GeneratedMessage {
  ...
  factory LikeForumInfo.fromBuffer($core.List<$core.int> data,
      ...
      LikeForumInfo()..mergeFromBuffer(data, registry);
  factory LikeForumInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      LikeForumInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LikeForumInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: LikeForumInfo.$_createMessage)
  ...
  @$core.Deprecated('Use LikeForumInfo() / LikeForumInfo.new instead')
  static LikeForumInfo create() => LikeForumInfo._();
  static $pb.GeneratedMessage $_createMessage() => LikeForumInfo._();
  @$core.override
  LikeForumInfo createEmptyInstance() => LikeForumInfo._();
  @$core.pragma('dart2js:noInline')
  static LikeForumInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LikeForumInfo>(
          LikeForumInfo.$_createMessage);

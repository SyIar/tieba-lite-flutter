...
class ForumRuleStatus extends $pb.GeneratedMessage {
  factory ForumRuleStatus({
    ...
    final result = ForumRuleStatus._();
  ...
  factory ForumRuleStatus.fromBuffer($core.List<$core.int> data,
      ...
      ForumRuleStatus()..mergeFromBuffer(data, registry);
  factory ForumRuleStatus.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ForumRuleStatus()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ForumRuleStatus',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ForumRuleStatus.$_createMessage)
  ...
  @$core.Deprecated('Use ForumRuleStatus() / ForumRuleStatus.new instead')
  static ForumRuleStatus create() => ForumRuleStatus._();
  static $pb.GeneratedMessage $_createMessage() => ForumRuleStatus._();
  @$core.override
  ForumRuleStatus createEmptyInstance() => ForumRuleStatus._();
  @$core.pragma('dart2js:noInline')
  static ForumRuleStatus getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ForumRuleStatus>(
          ForumRuleStatus.$_createMessage);

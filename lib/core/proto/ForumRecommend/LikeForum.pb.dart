...
class LikeForum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.PrivateForumInfo>(19, _omitFieldNames ? '' : 'privateForumInfo',
        subBuilder: $1.PrivateForumInfo.$_createMessage)
  ...
  @$core.Deprecated('Use LikeForum() / LikeForum.new instead')
  static LikeForum create() => LikeForum._();
  static $pb.GeneratedMessage $_createMessage() => LikeForum._();
  @$core.override
  LikeForum createEmptyInstance() => LikeForum._();
  @$core.pragma('dart2js:noInline')
  static LikeForum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LikeForum>(LikeForum.$_createMessage);

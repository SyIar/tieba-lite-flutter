...
class UserSessionInfo extends $pb.GeneratedMessage {
  factory UserSessionInfo({
    ...
    final result = UserSessionInfo._();
  ...
  factory UserSessionInfo.fromBuffer($core.List<$core.int> data,
      ...
      UserSessionInfo()..mergeFromBuffer(data, registry);
  factory UserSessionInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UserSessionInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UserSessionInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: UserSessionInfo.$_createMessage)
  ...
  @$core.Deprecated('Use UserSessionInfo() / UserSessionInfo.new instead')
  static UserSessionInfo create() => UserSessionInfo._();
  static $pb.GeneratedMessage $_createMessage() => UserSessionInfo._();
  @$core.override
  UserSessionInfo createEmptyInstance() => UserSessionInfo._();
  @$core.pragma('dart2js:noInline')
  static UserSessionInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserSessionInfo>(
          UserSessionInfo.$_createMessage);

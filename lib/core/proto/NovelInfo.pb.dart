...
class NovelInfo extends $pb.GeneratedMessage {
  ...
  factory NovelInfo.fromBuffer($core.List<$core.int> data,
      ...
      NovelInfo()..mergeFromBuffer(data, registry);
  factory NovelInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      NovelInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'NovelInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: NovelInfo.$_createMessage)
  ...
  @$core.Deprecated('Use NovelInfo() / NovelInfo.new instead')
  static NovelInfo create() => NovelInfo._();
  static $pb.GeneratedMessage $_createMessage() => NovelInfo._();
  @$core.override
  NovelInfo createEmptyInstance() => NovelInfo._();
  @$core.pragma('dart2js:noInline')
  static NovelInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NovelInfo>(NovelInfo.$_createMessage);

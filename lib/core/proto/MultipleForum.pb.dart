...
class MultipleForum extends $pb.GeneratedMessage {
  ...
  factory MultipleForum.fromBuffer($core.List<$core.int> data,
      ...
      MultipleForum()..mergeFromBuffer(data, registry);
  factory MultipleForum.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      MultipleForum()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MultipleForum',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: MultipleForum.$_createMessage)
  ...
  @$core.Deprecated('Use MultipleForum() / MultipleForum.new instead')
  static MultipleForum create() => MultipleForum._();
  static $pb.GeneratedMessage $_createMessage() => MultipleForum._();
  @$core.override
  MultipleForum createEmptyInstance() => MultipleForum._();
  @$core.pragma('dart2js:noInline')
  static MultipleForum getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MultipleForum>(
          MultipleForum.$_createMessage);

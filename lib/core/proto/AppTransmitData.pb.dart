...
class AppTransmitData extends $pb.GeneratedMessage {
  factory AppTransmitData({
    ...
    final result = AppTransmitData._();
  ...
  factory AppTransmitData.fromBuffer($core.List<$core.int> data,
      ...
      AppTransmitData()..mergeFromBuffer(data, registry);
  factory AppTransmitData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AppTransmitData()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AppTransmitData',
      createEmptyInstance: AppTransmitData.$_createMessage)
  ...
  @$core.Deprecated('Use AppTransmitData() / AppTransmitData.new instead')
  static AppTransmitData create() => AppTransmitData._();
  static $pb.GeneratedMessage $_createMessage() => AppTransmitData._();
  @$core.override
  AppTransmitData createEmptyInstance() => AppTransmitData._();
  @$core.pragma('dart2js:noInline')
  static AppTransmitData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AppTransmitData>(
          AppTransmitData.$_createMessage);

...
class DisplayWindowInfo extends $pb.GeneratedMessage {
  factory DisplayWindowInfo({
    ...
    final result = DisplayWindowInfo._();
  ...
  @$core.Deprecated('Use DisplayWindowInfo() / DisplayWindowInfo.new instead')
  static DisplayWindowInfo create() => DisplayWindowInfo._();
  static $pb.GeneratedMessage $_createMessage() => DisplayWindowInfo._();
  @$core.override
  DisplayWindowInfo createEmptyInstance() => DisplayWindowInfo._();
  @$core.pragma('dart2js:noInline')
  static DisplayWindowInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DisplayWindowInfo>(
          DisplayWindowInfo.$_createMessage);

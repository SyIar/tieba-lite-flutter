...
class AlaChallengeInfo extends $pb.GeneratedMessage {
  factory AlaChallengeInfo({
    ...
    final result = AlaChallengeInfo._();
  ...
  factory AlaChallengeInfo.fromBuffer($core.List<$core.int> data,
      ...
      AlaChallengeInfo()..mergeFromBuffer(data, registry);
  factory AlaChallengeInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      AlaChallengeInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AlaChallengeInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: AlaChallengeInfo.$_createMessage)
  ...
  @$core.Deprecated('Use AlaChallengeInfo() / AlaChallengeInfo.new instead')
  static AlaChallengeInfo create() => AlaChallengeInfo._();
  static $pb.GeneratedMessage $_createMessage() => AlaChallengeInfo._();
  @$core.override
  AlaChallengeInfo createEmptyInstance() => AlaChallengeInfo._();
  @$core.pragma('dart2js:noInline')
  static AlaChallengeInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AlaChallengeInfo>(
          AlaChallengeInfo.$_createMessage);

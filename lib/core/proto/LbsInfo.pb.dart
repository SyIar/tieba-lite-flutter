...
class LbsInfo extends $pb.GeneratedMessage {
  ...
  factory LbsInfo.fromBuffer($core.List<$core.int> data,
      ...
      LbsInfo()..mergeFromBuffer(data, registry);
  factory LbsInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      LbsInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LbsInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: LbsInfo.$_createMessage)
  ...
  @$core.Deprecated('Use LbsInfo() / LbsInfo.new instead')
  static LbsInfo create() => LbsInfo._();
  static $pb.GeneratedMessage $_createMessage() => LbsInfo._();
  @$core.override
  LbsInfo createEmptyInstance() => LbsInfo._();
  @$core.pragma('dart2js:noInline')
  static LbsInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LbsInfo>(LbsInfo.$_createMessage);

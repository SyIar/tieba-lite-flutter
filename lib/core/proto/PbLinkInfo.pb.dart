...
class PbLinkInfo extends $pb.GeneratedMessage {
  ...
  factory PbLinkInfo.fromBuffer($core.List<$core.int> data,
      ...
      PbLinkInfo()..mergeFromBuffer(data, registry);
  factory PbLinkInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PbLinkInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PbLinkInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PbLinkInfo.$_createMessage)
  ...
  @$core.Deprecated('Use PbLinkInfo() / PbLinkInfo.new instead')
  static PbLinkInfo create() => PbLinkInfo._();
  static $pb.GeneratedMessage $_createMessage() => PbLinkInfo._();
  @$core.override
  PbLinkInfo createEmptyInstance() => PbLinkInfo._();
  @$core.pragma('dart2js:noInline')
  static PbLinkInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PbLinkInfo>(PbLinkInfo.$_createMessage);

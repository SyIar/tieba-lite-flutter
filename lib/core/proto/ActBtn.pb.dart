...
class ActBtn extends $pb.GeneratedMessage {
  ...
  factory ActBtn.fromBuffer($core.List<$core.int> data,
      ...
      ActBtn()..mergeFromBuffer(data, registry);
  factory ActBtn.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ActBtn()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ActBtn',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ActBtn.$_createMessage)
  ...
  @$core.Deprecated('Use ActBtn() / ActBtn.new instead')
  static ActBtn create() => ActBtn._();
  static $pb.GeneratedMessage $_createMessage() => ActBtn._();
  @$core.override
  ActBtn createEmptyInstance() => ActBtn._();
  @$core.pragma('dart2js:noInline')
  static ActBtn getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ActBtn>(ActBtn.$_createMessage);

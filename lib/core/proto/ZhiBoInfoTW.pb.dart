...
class ZhiBoInfoTW extends $pb.GeneratedMessage {
  ...
  factory ZhiBoInfoTW.fromBuffer($core.List<$core.int> data,
      ...
      ZhiBoInfoTW()..mergeFromBuffer(data, registry);
  factory ZhiBoInfoTW.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ZhiBoInfoTW()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ZhiBoInfoTW',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ZhiBoInfoTW.$_createMessage)
    ..a<$fixnum.Int64>(
    ...
    ..aOM<$0.Zan>(6, _omitFieldNames ? '' : 'zan',
        subBuilder: $0.Zan.$_createMessage)
  ...
  @$core.Deprecated('Use ZhiBoInfoTW() / ZhiBoInfoTW.new instead')
  static ZhiBoInfoTW create() => ZhiBoInfoTW._();
  static $pb.GeneratedMessage $_createMessage() => ZhiBoInfoTW._();
  @$core.override
  ZhiBoInfoTW createEmptyInstance() => ZhiBoInfoTW._();
  @$core.pragma('dart2js:noInline')
  static ZhiBoInfoTW getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ZhiBoInfoTW>(
          ZhiBoInfoTW.$_createMessage);

...
class ThreadEasterEgg extends $pb.GeneratedMessage {
  factory ThreadEasterEgg({
    ...
    final result = ThreadEasterEgg._();
  ...
  factory ThreadEasterEgg.fromBuffer($core.List<$core.int> data,
      ...
      ThreadEasterEgg()..mergeFromBuffer(data, registry);
  factory ThreadEasterEgg.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      ThreadEasterEgg()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ThreadEasterEgg',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: ThreadEasterEgg.$_createMessage)
    ...
    ..aOM<$0.ShareInfo>(5, _omitFieldNames ? '' : 'shareInfo',
        subBuilder: $0.ShareInfo.$_createMessage)
  ...
  @$core.Deprecated('Use ThreadEasterEgg() / ThreadEasterEgg.new instead')
  static ThreadEasterEgg create() => ThreadEasterEgg._();
  static $pb.GeneratedMessage $_createMessage() => ThreadEasterEgg._();
  @$core.override
  ThreadEasterEgg createEmptyInstance() => ThreadEasterEgg._();
  @$core.pragma('dart2js:noInline')
  static ThreadEasterEgg getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThreadEasterEgg>(
          ThreadEasterEgg.$_createMessage);

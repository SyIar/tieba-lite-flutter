...
class UcCardInfo extends $pb.GeneratedMessage {
  ...
  factory UcCardInfo.fromBuffer($core.List<$core.int> data,
      ...
      UcCardInfo()..mergeFromBuffer(data, registry);
  factory UcCardInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UcCardInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UcCardInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: UcCardInfo.$_createMessage)
  ...
  @$core.Deprecated('Use UcCardInfo() / UcCardInfo.new instead')
  static UcCardInfo create() => UcCardInfo._();
  static $pb.GeneratedMessage $_createMessage() => UcCardInfo._();
  @$core.override
  UcCardInfo createEmptyInstance() => UcCardInfo._();
  @$core.pragma('dart2js:noInline')
  static UcCardInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UcCardInfo>(UcCardInfo.$_createMessage);

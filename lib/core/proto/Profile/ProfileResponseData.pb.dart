...
class ProfileResponseData extends $pb.GeneratedMessage {
  factory ProfileResponseData({
    ...
    final result = ProfileResponseData._();
  ...
  @$core
      .Deprecated('Use ProfileResponseData() / ProfileResponseData.new instead')
  static ProfileResponseData create() => ProfileResponseData._();
  static $pb.GeneratedMessage $_createMessage() => ProfileResponseData._();
  @$core.override
  ProfileResponseData createEmptyInstance() => ProfileResponseData._();
  @$core.pragma('dart2js:noInline')
  static ProfileResponseData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ProfileResponseData>(
          ProfileResponseData.$_createMessage);

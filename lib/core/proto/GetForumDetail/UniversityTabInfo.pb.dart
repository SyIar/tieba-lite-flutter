...
class UniversityTabInfo extends $pb.GeneratedMessage {
  factory UniversityTabInfo({
    ...
    final result = UniversityTabInfo._();
  ...
  factory UniversityTabInfo.fromBuffer($core.List<$core.int> data,
      ...
      UniversityTabInfo()..mergeFromBuffer(data, registry);
  factory UniversityTabInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      UniversityTabInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UniversityTabInfo',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tieba.getForumDetail'),
      createEmptyInstance: UniversityTabInfo.$_createMessage)
  ...
  @$core.Deprecated('Use UniversityTabInfo() / UniversityTabInfo.new instead')
  static UniversityTabInfo create() => UniversityTabInfo._();
  static $pb.GeneratedMessage $_createMessage() => UniversityTabInfo._();
  @$core.override
  UniversityTabInfo createEmptyInstance() => UniversityTabInfo._();
  @$core.pragma('dart2js:noInline')
  static UniversityTabInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UniversityTabInfo>(
          UniversityTabInfo.$_createMessage);

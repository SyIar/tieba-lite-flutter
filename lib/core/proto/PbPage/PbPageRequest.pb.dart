...
class PbPageRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use PbPageRequest() / PbPageRequest.new instead')
  static PbPageRequest create() => PbPageRequest._();
  static $pb.GeneratedMessage $_createMessage() => PbPageRequest._();
  @$core.override
  PbPageRequest createEmptyInstance() => PbPageRequest._();
  @$core.pragma('dart2js:noInline')
  static PbPageRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PbPageRequest>(
          PbPageRequest.$_createMessage);

...
class PsRankListItem extends $pb.GeneratedMessage {
  ...
  factory PsRankListItem.fromBuffer($core.List<$core.int> data,
      ...
      PsRankListItem()..mergeFromBuffer(data, registry);
  factory PsRankListItem.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PsRankListItem()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PsRankListItem',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PsRankListItem.$_createMessage)
    ..aInt64(1, _omitFieldNames ? '' : 'gameId')
    ..aInt64(2, _omitFieldNames ? '' : 'userId')
    ..aInt64(3, _omitFieldNames ? '' : 'score')
    ..aOM<$0.User>(4, _omitFieldNames ? '' : 'user',
  ...
  @$core.Deprecated('Use PsRankListItem() / PsRankListItem.new instead')
  static PsRankListItem create() => PsRankListItem._();
  static $pb.GeneratedMessage $_createMessage() => PsRankListItem._();
  @$core.override
  PsRankListItem createEmptyInstance() => PsRankListItem._();
  @$core.pragma('dart2js:noInline')
  static PsRankListItem getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PsRankListItem>(
          PsRankListItem.$_createMessage);

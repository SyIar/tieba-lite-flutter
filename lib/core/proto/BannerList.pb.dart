...
class BannerList extends $pb.GeneratedMessage {
  ...
  factory BannerList.fromBuffer($core.List<$core.int> data,
      ...
      BannerList()..mergeFromBuffer(data, registry);
  factory BannerList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BannerList()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BannerList',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BannerList.$_createMessage)
    ..pPM<$0.App>(1, _omitFieldNames ? '' : 'app',
        subBuilder: $0.App.$_createMessage)
    ..pPM<$1.FeedForumInfo>(2, _omitFieldNames ? '' : 'feedForum',
        subBuilder: $1.FeedForumInfo.$_createMessage)
    ..aOM<$2.RecomTopicInfo>(3, _omitFieldNames ? '' : 'hotTopic',
        subBuilder: $2.RecomTopicInfo.$_createMessage)
  ...
  @$core.Deprecated('Use BannerList() / BannerList.new instead')
  static BannerList create() => BannerList._();
  static $pb.GeneratedMessage $_createMessage() => BannerList._();
  @$core.override
  BannerList createEmptyInstance() => BannerList._();
  @$core.pragma('dart2js:noInline')
  static BannerList getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BannerList>(BannerList.$_createMessage);

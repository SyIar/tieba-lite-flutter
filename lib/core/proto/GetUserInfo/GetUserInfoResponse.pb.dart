...
class GetUserInfoResponse extends $pb.GeneratedMessage {
  factory GetUserInfoResponse({
    ...
    final result = GetUserInfoResponse._();
  ...
  @$core
      .Deprecated('Use GetUserInfoResponse() / GetUserInfoResponse.new instead')
  static GetUserInfoResponse create() => GetUserInfoResponse._();
  static $pb.GeneratedMessage $_createMessage() => GetUserInfoResponse._();
  @$core.override
  GetUserInfoResponse createEmptyInstance() => GetUserInfoResponse._();
  @$core.pragma('dart2js:noInline')
  static GetUserInfoResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetUserInfoResponse>(
          GetUserInfoResponse.$_createMessage);

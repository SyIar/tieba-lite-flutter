...
class ReplyList extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use ReplyList() / ReplyList.new instead')
  static ReplyList create() => ReplyList._();
  static $pb.GeneratedMessage $_createMessage() => ReplyList._();
  @$core.override
  ReplyList createEmptyInstance() => ReplyList._();
  @$core.pragma('dart2js:noInline')
  static ReplyList getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ReplyList>(ReplyList.$_createMessage);

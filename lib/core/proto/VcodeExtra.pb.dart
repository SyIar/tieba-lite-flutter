...
class VcodeExtra extends $pb.GeneratedMessage {
  ...
  factory VcodeExtra.fromBuffer($core.List<$core.int> data,
      ...
      VcodeExtra()..mergeFromBuffer(data, registry);
  factory VcodeExtra.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      VcodeExtra()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'VcodeExtra',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: VcodeExtra.$_createMessage)
  ...
  @$core.Deprecated('Use VcodeExtra() / VcodeExtra.new instead')
  static VcodeExtra create() => VcodeExtra._();
  static $pb.GeneratedMessage $_createMessage() => VcodeExtra._();
  @$core.override
  VcodeExtra createEmptyInstance() => VcodeExtra._();
  @$core.pragma('dart2js:noInline')
  static VcodeExtra getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VcodeExtra>(VcodeExtra.$_createMessage);

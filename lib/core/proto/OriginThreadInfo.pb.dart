...
class OriginThreadInfo extends $pb.GeneratedMessage {
  factory OriginThreadInfo({
    ...
    final result = OriginThreadInfo._();
  ...
  factory OriginThreadInfo.fromBuffer($core.List<$core.int> data,
      ...
      OriginThreadInfo()..mergeFromBuffer(data, registry);
  factory OriginThreadInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      OriginThreadInfo()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OriginThreadInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: OriginThreadInfo.$_createMessage)
    ...
    ..aOM<$2.AlaLiveInfo>(6, _omitFieldNames ? '' : 'alaInfo',
        subBuilder: $2.AlaLiveInfo.$_createMessage)
    ...
    ..aOM<$9.PollInfo>(21, _omitFieldNames ? '' : 'pollInfo',
        subBuilder: $9.PollInfo.$_createMessage)
    ..aOM<$10.Item>(22, _omitFieldNames ? '' : 'item',
        subBuilder: $10.Item.$_createMessage)
    ..pPM<$11.HeadItem>(23, _omitFieldNames ? '' : 'itemStar',
        subBuilder: $11.HeadItem.$_createMessage)
    ..pPM<$12.PbLinkInfo>(24, _omitFieldNames ? '' : 'pbLinkInfo',
        subBuilder: $12.PbLinkInfo.$_createMessage)
  ...
  @$core.Deprecated('Use OriginThreadInfo() / OriginThreadInfo.new instead')
  static OriginThreadInfo create() => OriginThreadInfo._();
  static $pb.GeneratedMessage $_createMessage() => OriginThreadInfo._();
  @$core.override
  OriginThreadInfo createEmptyInstance() => OriginThreadInfo._();
  @$core.pragma('dart2js:noInline')
  static OriginThreadInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<OriginThreadInfo>(
          OriginThreadInfo.$_createMessage);

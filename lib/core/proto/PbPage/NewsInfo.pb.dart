...
class NewsInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('Use NewsInfo() / NewsInfo.new instead')
  static NewsInfo create() => NewsInfo._();
  static $pb.GeneratedMessage $_createMessage() => NewsInfo._();
  @$core.override
  NewsInfo createEmptyInstance() => NewsInfo._();
  @$core.pragma('dart2js:noInline')
  static NewsInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NewsInfo>(NewsInfo.$_createMessage);

...
class PrivSets extends $pb.GeneratedMessage {
  ...
  factory PrivSets.fromBuffer($core.List<$core.int> data,
      ...
      PrivSets()..mergeFromBuffer(data, registry);
  factory PrivSets.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      PrivSets()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PrivSets',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: PrivSets.$_createMessage)
  ...
  @$core.Deprecated('Use PrivSets() / PrivSets.new instead')
  static PrivSets create() => PrivSets._();
  static $pb.GeneratedMessage $_createMessage() => PrivSets._();
  @$core.override
  PrivSets createEmptyInstance() => PrivSets._();
  @$core.pragma('dart2js:noInline')
  static PrivSets getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PrivSets>(PrivSets.$_createMessage);

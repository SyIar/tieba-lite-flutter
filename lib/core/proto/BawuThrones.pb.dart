...
class BawuThrones extends $pb.GeneratedMessage {
  ...
  factory BawuThrones.fromBuffer($core.List<$core.int> data,
      ...
      BawuThrones()..mergeFromBuffer(data, registry);
  factory BawuThrones.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      BawuThrones()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'BawuThrones',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'tieba'),
      createEmptyInstance: BawuThrones.$_createMessage)
  ...
  @$core.Deprecated('Use BawuThrones() / BawuThrones.new instead')
  static BawuThrones create() => BawuThrones._();
  static $pb.GeneratedMessage $_createMessage() => BawuThrones._();
  @$core.override
  BawuThrones createEmptyInstance() => BawuThrones._();
  @$core.pragma('dart2js:noInline')
  static BawuThrones getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BawuThrones>(
          BawuThrones.$_createMessage);
